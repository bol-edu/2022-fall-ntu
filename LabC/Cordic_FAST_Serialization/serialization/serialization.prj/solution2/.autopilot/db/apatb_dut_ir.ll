; ModuleID = 'C:/Xilinx/Vitis_HLS/2022.1/serialization/serialization.prj/solution2/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  %src_buff_copy = alloca i8, align 512
  %dst_buff_copy = alloca i8, align 512
  call fastcc void @copy_in(i8* nonnull %src_buff, i8* nonnull align 512 %src_buff_copy, i8* nonnull %dst_buff, i8* nonnull align 512 %dst_buff_copy)
  call void @apatb_dut_hw(i8* %src_buff_copy, i32 %src_sz, i8* %dst_buff_copy)
  call void @copy_back(i8* %src_buff, i8* %src_buff_copy, i8* %dst_buff, i8* %dst_buff_copy)
  ret void
}
...
entry:
  call void @copy_out(i8* null, i8* %0, i8* null, i8* %2)
  call void @dut_hw_stub(i8* %0, i32 %1, i8* %2)
  call void @copy_in(i8* null, i8* %0, i8* null, i8* %2)
  ret void
}
