...
if {[file isfile fast_accel.autotvin.dat]} {
	file delete -force fast_accel.autotvin.dat
}

if {[file isfile fast_accel.autotvout.dat]} {
	file delete -force fast_accel.autotvout.dat
}
