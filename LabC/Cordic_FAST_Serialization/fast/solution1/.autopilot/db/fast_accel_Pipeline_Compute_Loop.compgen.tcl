...
set id 1
set name fast_accel_mac_muladd_15s_10s_7ns_15_4_1
...
set ce_signed 0
set out_width 15
set arg_lists {i0 {15 1 +} i1 {10 1 +} m {15 1 +} i2 {7 0 +} p {15 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
set id 2
set name fast_accel_mac_muladd_7ns_15s_7ns_15_4_1
set corename simcore_mac
set op mac
set stage_num 4
set clk_width 1
...
set ce_signed 0
set out_width 15
set arg_lists {i0 {7 0 +} i1 {15 1 +} m {15 1 +} i2 {7 0 +} p {15 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {all} IMPL {dsp48} LATENCY 3 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_op2_assign_1 \
    op interface \
    ports { op2_assign_1 { I 32 vector } } \
} "
}
