...
__attribute__((sdx_kernel("dft", 0))) void dft(DTYPE XX_R[1024], DTYPE XX_I[1024], DTYPE OUT_R[1024], DTYPE OUT_I[1024]);
# 10 "fft.cpp" 2

template<int stage>
void fft_stage(DTYPE X_R[1024], DTYPE X_I[1024], DTYPE OUT_R[1024], DTYPE OUT_I[1024]);
void bit_reverse(DTYPE X_R[1024], DTYPE X_I[1024], DTYPE OUT_R[1024], DTYPE OUT_I[1024]);




__attribute__((sdx_kernel("dft", 0))) void dft(DTYPE X_R[1024], DTYPE X_I[1024], DTYPE OUT_R[1024], DTYPE OUT_I[1024]) {
#line 20 "C:/Users/User/Documents/HLS/LabC/DFT/dft/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=dft
# 18 "fft.cpp"

#line 6 "C:/Users/User/Documents/HLS/LabC/DFT/dft/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=dft
# 18 "fft.cpp"
...
#pragma HLS INTERFACE mode=ap_memory port=OUT_I
 ...
 DTYPE buf0_R[1024], buf0_I[1024];
 DTYPE buf1_R[1024], buf1_I[1024];
