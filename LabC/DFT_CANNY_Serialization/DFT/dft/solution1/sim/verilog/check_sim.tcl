...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.dft.autotvin_X_R.dat"
         "c.dft.autotvin_X_I.dat"
         "c.dft.autotvin_OUT_R_1.dat"
         "c.dft.autotvin_OUT_R_2.dat"
         "c.dft.autotvin_OUT_R_3.dat"
         "c.dft.autotvin_OUT_I_1.dat"
         "c.dft.autotvin_OUT_I_2.dat"
         "c.dft.autotvin_OUT_I_3.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.dft.autotvout_OUT_R_0.dat"
         "rtl.dft.autotvout_OUT_R_1.dat"
         "rtl.dft.autotvout_OUT_R_2.dat"
         "rtl.dft.autotvout_OUT_R_3.dat"
         "rtl.dft.autotvout_OUT_I_0.dat"
         "rtl.dft.autotvout_OUT_I_1.dat"
         "rtl.dft.autotvout_OUT_I_2.dat"
         "rtl.dft.autotvout_OUT_I_3.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
