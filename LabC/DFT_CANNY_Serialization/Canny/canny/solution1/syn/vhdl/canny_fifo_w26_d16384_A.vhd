...
entity canny_fifo_w26_d16384_A is
    generic (
...
architecture arch of canny_fifo_w26_d16384_A is

    -- component
    component canny_fifo_w26_d16384_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_canny_fifo_w26_d16384_A_ram : canny_fifo_w26_d16384_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity canny_fifo_w26_d16384_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 26;
        ADDR_WIDTH  : integer := 14;
...
architecture arch of canny_fifo_w26_d16384_A_ram is
