...
entity canny_fifo_w20_d21846_A is
    generic (
...
architecture arch of canny_fifo_w20_d21846_A is

    -- component
    component canny_fifo_w20_d21846_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_canny_fifo_w20_d21846_A_ram : canny_fifo_w20_d21846_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity canny_fifo_w20_d21846_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 20;
        ADDR_WIDTH  : integer := 15;
...
architecture arch of canny_fifo_w20_d21846_A_ram is
