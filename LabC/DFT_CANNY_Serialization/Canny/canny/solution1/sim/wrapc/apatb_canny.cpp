...
extern "C"
void canny_hw_stub_wrapper(void*, void*, hls::sim::Byte<4>, hls::sim::Byte<4>);

extern "C"
void apatb_canny_hw(void* __xlx_apatb_param_src, void* __xlx_apatb_param_dst, hls::sim::Byte<4> __xlx_apatb_param_upperThresh, hls::sim::Byte<4> __xlx_apatb_param_lowerThresh)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_upperThresh),
#endif
  };
  port0.param = &__xlx_apatb_param_upperThresh;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_lowerThresh),
#endif
  };
  port1.param = &__xlx_apatb_param_lowerThresh;
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port2 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_src),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_src),
#endif
#endif
  };
  port2.param = { __xlx_apatb_param_src };
  port2.depth = { 16384 };
  port2.offset = {  };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_dst),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_dst),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_dst),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_dst),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_dst),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_dst),
#endif
#endif
  };
  port3.param = { __xlx_apatb_param_dst };
  port3.depth = { 16384 };
  port3.offset = {  };
  port3.hasWrite = { true };
