...
set name dut_srem_33ns_5ns_33_37_seq_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {srem} IMPL {auto_seq} LATENCY 36 ALLOW_PRAGMA 1
}
...
set ID 367
set hasByteEnable 0
set MemName dut_dst_buf0_RAM_AUTO_1R1W
...
set ID 368
set hasByteEnable 0
set MemName dut_val_buf0_RAM_AUTO_1R1W
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 8
set AddrRange 4000
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { src_TDATA { I 8 vector } src_TVALID { I 1 bit } src_TREADY { O 1 bit } } \
} "
} else {
