...
{
auto *pos = (unsigned char*)__xlx_apatb_param_in_out1;
aesl_fh.write(AUTOTB_TVIN_in_out1, formatData(pos, 32));
}
...
{
auto *pos = (unsigned char*)__xlx_apatb_param_in_out1;
aesl_fh.write(AUTOTB_TVOUT_in_out1, formatData(pos, 32));
}
  tcl_file.set_num(1, &tcl_file.in_out1_depth);
