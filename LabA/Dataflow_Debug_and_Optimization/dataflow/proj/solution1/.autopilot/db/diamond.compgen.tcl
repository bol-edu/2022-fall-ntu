...
set ID 11
set hasByteEnable 0
set MemName diamond_c1_RAM_AUTO_1R1W_memcore
...
set MemName diamond_c1_RAM_AUTO_1R1W
...
set ID 12
set hasByteEnable 0
set MemName diamond_c2_RAM_AUTO_1R1W_memcore
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 6
set AddrRange 100
...
set FullThresh 0
set CoreName ap_simcore_mem_df_channel
set MemName diamond_c2_RAM_AUTO_1R1W
if {${::AESL::PGuard_autocg_gen} || ${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mem_df_channel] == "ap_gen_simcore_mem_df_channel"} {
    eval "ap_gen_simcore_mem_df_channel { \
    id ${ID} \
...
set ID 13
set hasByteEnable 0
set MemName diamond_c4_RAM_AUTO_1R1W_memcore
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 7
set AddrRange 100
...
set FullThresh 0
set CoreName ap_simcore_mem_df_channel
set MemName diamond_c4_RAM_AUTO_1R1W
if {${::AESL::PGuard_autocg_gen} || ${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mem_df_channel] == "ap_gen_simcore_mem_df_channel"} {
    eval "ap_gen_simcore_mem_df_channel { \
    id ${ID} \
