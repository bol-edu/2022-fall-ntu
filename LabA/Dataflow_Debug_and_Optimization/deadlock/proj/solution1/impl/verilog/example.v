...
(* CORE_GENERATION_INFO="example_example,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu9p-flgc2104-2-i,HLS_INPUT_CLOCK=2.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=1.460000,HLS_SYN_LAT=36,HLS_SYN_TPT=31,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=530,HLS_SYN_LUT=1436,HLS_VERSION=2022_1}" *)
...
example_fifo_w32_d40_S_x0 data_channel1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
example_fifo_w32_d40_S_x0 data_channel2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
