...
__attribute__((sdx_kernel("example", 0))) void example(hls::stream<int>& A, hls::stream<int>& B){
#line 16 "/mnt/HLSNAS/03.jkrvGE/r10525034/LabA/Vitis-Tutorials/Hardware_Acceleration/Feature_Tutorials/03-dataflow_debug_and_optimization/reference_files/deadlock/proj/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=example
# 18 "example.cpp"

#line 6 "/mnt/HLSNAS/03.jkrvGE/r10525034/LabA/Vitis-Tutorials/Hardware_Acceleration/Feature_Tutorials/03-dataflow_debug_and_optimization/reference_files/deadlock/proj/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=example
# 18 "example.cpp"
...
void proc_1_1(hls::stream<int>& A, hls::stream<int>& data_channel1, hls::stream<int>& data_channel2){
  int i;
  int tmp;
  VITIS_LOOP_42_1: for(i = 0; i < 10; i++){
    tmp = A.read();
    data_channel1.write(tmp);
  }
  VITIS_LOOP_46_2: for(i = 0; i < 10; i++){
...
void proc_1_2(hls::stream<int>& B, hls::stream<int>& C, hls::stream<int>& data_channel1, hls::stream<int>& data_channel2){
  ...
  VITIS_LOOP_55_1: for(i = 0; i < 10; i++){
    tmp = data_channel2.read() + data_channel1.read();
    B.write(tmp);
  }
  VITIS_LOOP_59_2: for(i = 0; i < 10; i++){
    C.write(tmp);
  }
}
...
void proc_2_1(hls::stream<int>& A, hls::stream<int>& B, hls::stream<int>& data_channel1, hls::stream<int>& data_channel2){
  int i;
  int tmp;
  VITIS_LOOP_76_1: for(i = 0; i < 10; i++){
    tmp = A.read() + B.read();
    data_channel1.write(tmp);
  }
  VITIS_LOOP_80_2: for(i = 0; i < 10; i++){
    data_channel2.write(tmp);
  }
}
...
void proc_2_2(hls::stream<int>& C, hls::stream<int>& data_channel1, hls::stream<int>& data_channel2){
  int i;
  int tmp;
  VITIS_LOOP_88_1: for(i = 0; i < 10; i++){
    tmp = data_channel2.read() + data_channel1.read();
    C.write(tmp);
  }
}
