...
// ==============================================================
# 1 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp"
# 9 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp"
...
# 10 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp" 2
...
using std::tgamma;
using std::trunc;
# 11 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp" 2
...
using std::wcstombs;
using std::wctomb;
# 12 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp" 2
...
# 13 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp" 2

#ifndef HLS_FASTSIM
#ifndef HLS_FASTSIM
#include "apatb_fir.h"
#endif
# 14 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp"
int main () {
...
#endif
# 29 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp"
fir(&output,signal);
#undef fir
# 29 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp"
  ...
  printf ("Comparing against output data \n");
   ...
   fprintf(
# 41 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp" 3
          (&__iob_func()[1])
# 41 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp"
                , "*******************************************\n");
   fprintf(
# 42 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp" 3
          (&__iob_func()[1])
# 42 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp"
                , "FAIL: Output DOES NOT match the golden output\n");
   fprintf(
# 43 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp" 3
          (&__iob_func()[1])
# 43 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp"
                , "*******************************************\n");
       return 1;
    } else {
   fprintf(
# 46 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp" 3
          (&__iob_func()[1])
# 46 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp"
                , "*******************************************\n");
   fprintf(
# 47 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp" 3
          (&__iob_func()[1])
# 47 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp"
                , "PASS: The output matches the golden output!\n");
   fprintf(
# 48 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp" 3
          (&__iob_func()[1])
# 48 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp"
                , "*******************************************\n");
       return 0;
    }
...
#endif
# 52 "C:/9m/HLS/labb/project1/fir11/fir_test.cpp"
