...
void matrixmul(
      ...
      mat_b_t b[8][8],
      result_t res[8][8])
{_ssdm_SpecArrayDimSize(a, 8);_ssdm_SpecArrayDimSize(b, 8);_ssdm_SpecArrayDimSize(res, 8);
_ssdm_SpecArrayReshape( a, 2,  "BLOCK",  2, "");
# 52 "matrixmul.cpp"

_ssdm_SpecArrayReshape( b, 1,  "BLOCK",  2, "");
# 52 "matrixmul.cpp"
