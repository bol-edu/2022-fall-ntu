...
// 0x18 : reserved
// 0x1c : Data signal of SNR
//        bit 31~0 - SNR[31:0] (Read/Write)
// 0x20 : reserved
// 0x24 : Data signal of max_iter
//        bit 31~0 - max_iter[31:0] (Read/Write)
// 0x28 : reserved
...
localparam
    ...
    ADDR_SNR_DATA_0      = 6'h1c,
    ADDR_SNR_CTRL        = 6'h20,
    ADDR_MAX_ITER_DATA_0 = 6'h24,
    ADDR_MAX_ITER_CTRL   = 6'h28,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_MAX_ITER_DATA_0: begin
                    rdata <= int_max_iter[31:0];
                end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_MAX_ITER_DATA_0)
            int_max_iter[31:0] <= (WDATA[31:0] & wmask) | (int_max_iter[31:0] & ~wmask);
    end
end
