...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hdc_maxi.autotvin.dat"
	set constFileTvOut       "hdc_maxi.autotvout.dat"
	set constFileHdlTvIn     "hdc_maxi.autohdltvin.dat"
	set constFileHdlTvOut    "hdc_maxi.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
