...
$(ObjDir)/HDCTester.cpp_pre.cpp.tb.o : HDCTester.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling HDCTester.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/HDC.cpp_pre.cpp.tb.o : HDC.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling HDC.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
