...
if {[file isfile hdc_maxi.autotvin.dat]} {
	file delete -force hdc_maxi.autotvin.dat
}

if {[file isfile hdc_maxi.autotvout.dat]} {
	file delete -force hdc_maxi.autotvout.dat
}
