# 1 "AAHLS_Final_Project_deploy/HDC.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "AAHLS_Final_Project_deploy/HDC.cpp" 2


# 1 "AAHLS_Final_Project_deploy/HDC.h" 1
...
# 3 "AAHLS_Final_Project_deploy/HDC.h" 2
...
__attribute__((sdx_kernel("hdc_maxi", 0))) void hdc_maxi(hls::stream<ap_axis<32,1,1,1>>* test_data, hls::stream<ap_axis<32,1,1,1>>* test_label_out, hls::stream<ap_axis<32,1,1,1>>* IM, hls::stream<ap_axis<32,1,1,1>>* AM_out);
# 4 "AAHLS_Final_Project_deploy/HDC.cpp" 2

__attribute__((sdx_kernel("hdc_maxi", 0))) void hdc_maxi(hls::stream<ap_axis<32,1,1,1>>* test_data, hls::stream<ap_axis<32,1,1,1>>* test_label_out, hls::stream<ap_axis<32,1,1,1>>* IM, hls::stream<ap_axis<32,1,1,1>>* AM_out)
{
#line 20 "C:/Users/kevin/Desktop/AAHLS_Final_Project_deploy/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=hdc_maxi
# 6 "AAHLS_Final_Project_deploy/HDC.cpp"

#line 6 "C:/Users/kevin/Desktop/AAHLS_Final_Project_deploy/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=hdc_maxi
# 6 "AAHLS_Final_Project_deploy/HDC.cpp"
...
#pragma HLS INTERFACE s_axilite port=return
 ...
 int new_IM[1000];
#line 7 "C:/Users/kevin/Desktop/AAHLS_Final_Project_deploy/solution1/directives.tcl"
#pragma HLSDIRECTIVE ARRAY_RESHAPE variable=new_IM cyclic factor=256 dim=1
# 14 "AAHLS_Final_Project_deploy/HDC.cpp"
    ...
    int AM[5][1000];
#line 10 "C:/Users/kevin/Desktop/AAHLS_Final_Project_deploy/solution1/directives.tcl"
#pragma HLSDIRECTIVE ARRAY_RESHAPE variable=AM cyclic factor=4 dim=2
# 20 "AAHLS_Final_Project_deploy/HDC.cpp"

 VITIS_LOOP_21_2: for(int i=0; i<5; i++){
  VITIS_LOOP_22_3: for(int j=0; j<1000; j++){
 ...
 hdc_maxi_label0:for(int d=0; d<2; d++){
  ...
  int ngram[380];
#line 9 "C:/Users/kevin/Desktop/AAHLS_Final_Project_deploy/solution1/directives.tcl"
#pragma HLSDIRECTIVE ARRAY_RESHAPE variable=ngram cyclic factor=4 dim=1
# 33 "AAHLS_Final_Project_deploy/HDC.cpp"

     VITIS_LOOP_34_4: for(int i=0; i<380; i++){
#pragma HLS UNROLL factor=380
 ngram[i] = 1;
     }

  int test_data_d [320];
#line 8 "C:/Users/kevin/Desktop/AAHLS_Final_Project_deploy/solution1/directives.tcl"
#pragma HLSDIRECTIVE ARRAY_RESHAPE variable=test_data_d cyclic factor=16 dim=1
# 39 "AAHLS_Final_Project_deploy/HDC.cpp"

     VITIS_LOOP_40_5: for(int i=0; i<320; i++){
      ap_axis<32,1,1,1> tmp = test_data->read();
      test_data_d[i] = tmp.data;
      valDataCtrl = tmp;
     }

     VITIS_LOOP_46_6: for(int t=0; t<5; t++){

      VITIS_LOOP_48_7: for(int i=0; i<380; i++){
       int tmp = 0;

       VITIS_LOOP_51_8: for(int e=0; e<64; e++){
#pragma HLS UNROLL factor=2


 if(new_IM[i + e + t] == 0) tmp = tmp + test_data_d[t * 64 + e];
        else tmp = tmp - test_data_d[t * 64 + e];
       }
...
#pragma HLS dependence variable=ngram type=inter direction=RAW false
 if(tmp < 0){
     ...
     int maxSim = -1;
     int label = -1;
     VITIS_LOOP_68_9: for(int c=0; c<5; c++){
      int dot_product = 0;
      VITIS_LOOP_70_10: for(int i=0; i<380; i++){
