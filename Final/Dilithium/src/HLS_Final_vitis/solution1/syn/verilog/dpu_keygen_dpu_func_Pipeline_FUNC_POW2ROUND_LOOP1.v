...
module dpu_keygen_dpu_func_Pipeline_FUNC_POW2ROUND_LOOP1 (
        ...
        addr3_cast_cast,
        this_3_19_out,
        this_3_19_out_ap_vld,
        this_4_19_out,
        this_4_19_out_ap_vld,
        this_1_18_out,
        this_1_18_out_ap_vld,
...
output  [8191:0] this_3_19_out;
output   this_3_19_out_ap_vld;
output  [8191:0] this_4_19_out;
output   this_4_19_out_ap_vld;
output  [8191:0] this_1_18_out;
output   this_1_18_out_ap_vld;
...
reg this_3_19_out_ap_vld;
reg this_4_19_out_ap_vld;
reg this_1_18_out_ap_vld;
...
reg   [8191:0] this_4_ret6_reg_382;
...
reg   [2:0] i_fu_80;
wire   [2:0] i_41_fu_234_p2;
wire    ap_loop_init;
reg   [2:0] ap_sig_allocacmp_i_40;
reg   [8191:0] this_1_18_fu_84;
reg   [8191:0] this_4_19_fu_88;
reg   [8191:0] this_3_19_fu_92;
...
always @ (*) begin
    if (((icmp_ln286_fu_228_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        this_1_18_out_ap_vld = 1'b1;
    end else begin
        this_1_18_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln286_fu_228_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        this_3_19_out_ap_vld = 1'b1;
    end else begin
        this_3_19_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln286_fu_228_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        this_4_19_out_ap_vld = 1'b1;
    end else begin
        this_4_19_out_ap_vld = 1'b0;
    end
end
...
assign grp_dpu_unit_fu_2782_p_ce = grp_dpu_unit_fu_172_ap_ce;

assign grp_dpu_unit_fu_2782_p_din1 = call_ret_reg_371;

assign grp_dpu_unit_fu_2782_p_din2 = p_read1;

assign grp_dpu_unit_fu_2782_p_din3 = this_4_19_fu_88;

assign grp_dpu_unit_fu_2782_p_din4 = 8'd6;

assign grp_read_p1_fu_165_ap_start = grp_read_p1_fu_165_ap_start_reg;

assign i_41_fu_234_p2 = (ap_sig_allocacmp_i_40 + 3'd1);

assign icmp_ln286_fu_228_p2 = ((ap_sig_allocacmp_i_40 == trunc_ln53) ? 1'b1 : 1'b0);

assign this_1_18_out = this_1_18_fu_84;

assign this_3_19_out = this_3_19_fu_92;

assign this_4_19_out = this_4_19_fu_88;

assign zext_ln288_1_fu_244_p1 = ap_sig_allocacmp_i_40;

assign zext_ln288_fu_240_p1 = ap_sig_allocacmp_i_40;
