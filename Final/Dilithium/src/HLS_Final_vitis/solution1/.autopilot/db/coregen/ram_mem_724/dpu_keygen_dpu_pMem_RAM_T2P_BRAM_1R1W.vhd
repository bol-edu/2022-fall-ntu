...
entity dpu_keygen_dpu_pMem_RAM_T2P_BRAM_1R1W is 
    generic(
            MEM_TYPE    : string := "block"; 
            DataWidth     : integer := 8192; 
            AddressWidth     : integer := 8; 
            AddressRange    : integer := 158;
            COL_WIDTH    : integer := 8;
            NUM_COL      : integer := 1024
    ); 
    port (
...
architecture rtl of dpu_keygen_dpu_pMem_RAM_T2P_BRAM_1R1W is 
