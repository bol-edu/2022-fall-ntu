...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename seedbuf \
    op interface \
    ports { seedbuf_address0 { O 7 vector } seedbuf_ce0 { O 1 bit } seedbuf_we0 { O 1 bit } seedbuf_d0 { O 8 vector } seedbuf_address1 { O 7 vector } seedbuf_ce1 { O 1 bit } seedbuf_we1 { O 1 bit } seedbuf_d1 { O 8 vector } } \
} "
} else {
