set moduleName dpu_func_Pipeline_FUNC_MONTMUL_LOOP3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {dpu_func_Pipeline_FUNC_MONTMUL_LOOP3}
...
set portList { 
	...
	{ trunc_ln50 sc_in sc_lv 3 signal 3 } 
	...
	{ call_ret22 sc_in sc_lv 8192 signal 5 } 
	{ this_3_8_out sc_out sc_lv 8192 signal 6 } 
	{ this_3_8_out_ap_vld sc_out sc_logic 1 outvld 6 } 
	{ this_4_8_out sc_out sc_lv 8192 signal 7 } 
	{ this_4_8_out_ap_vld sc_out sc_logic 1 outvld 7 } 
	{ this_1_8_out sc_out sc_lv 8192 signal 8 } 
	{ this_1_8_out_ap_vld sc_out sc_logic 1 outvld 8 } 
...
set RtlHierarchyInfo {[
		...
		"Port" : [
			...
			{"Name" : "this_0", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					...
					{"ID" : "2", "SubInstance" : "call_ln212_write_p4_fu_153", "Port" : "this_pMem", "Inst_start_state" : "32", "Inst_end_state" : "32"}]},
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.call_ln212_write_p4_fu_153", "Parent" : "0",
		"CDFG" : "write_p4",
		"Protocol" : "ap_ctrl_hs",
