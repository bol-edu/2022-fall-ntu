set moduleName dpu_pack_4_Pipeline_VITIS_LOOP_91_1
set isTopModule 0
...
set portList { 
	...
	{ idxprom2_i75 sc_in sc_lv 6 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "idxprom2_i75", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "idxprom2_i75", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	idxprom2_i75 { ap_none {  { idxprom2_i75 in_data 0 6 } } }
