...
// ==============================================================
# 1 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp"
...
# 2 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp" 2
...
# 3 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp" 2
...
# 4 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp" 2
...
# 5 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp" 2
...
# 6 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp" 2
...
# 7 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp" 2
...
#pragma HLS ARRAY_RESHAPE dim=1 type=complete variable=tmp
  ...
  spu.shake(256, seedbuf, 3*32, seedbuf, 32);
  rho = seedbuf;
  rhoprime = seedbuf + 32;
  key = seedbuf + 2*32;

SAMPA_LOOP0:for(unsigned int k = 0; k < 6; ++k){
SAMPA_LOOP1:for(unsigned int p = 0; p < 5; ++p){
      spu.sample_uniform(tmp, rho, (k << 8) + p);
      dpu.write_Mem(tmp, 0 +5*k+p);
    }
  }
SAMPETA_LOOP0:for(unsigned int k = 0; k < 5; ++k){
    spu.sample_eta(tmp, rhoprime, k);
    dpu.write_Mem(tmp, 5*6 + 5 +k);
    dpu.write_Mem(tmp, 5*6 +k);
  }
SAMPETA_LOOP1:for(unsigned int k = 0; k < 6; ++k){
    spu.sample_eta(tmp, rhoprime, 5 +k);
    dpu.write_Mem(tmp, 5*6 + 3*5 + 6 +k);
  }
  dpu.dpu_func( 5*6 + 5, 0, 0, 7, 0, 5);
  dpu.dpu_func( 0,5*6 + 5, 5*6 + 3*5 + 3*6, 4, 0, 5);
  dpu.dpu_func( 5*6 + 3*5 + 3*6, 0, 0, 2, 0, 6);
  dpu.dpu_func( 5*6 + 3*5 + 3*6, 0, 0, 8, 0, 6);
  dpu.dpu_func(5*6 + 3*5 + 5*6 + 1 + 6*10 + 18, 5*6 + 3*5 + 3*6, 5*6 + 3*5 + 3*6, 3, 0, 6);
  dpu.dpu_func( 5*6 + 3*5 + 3*6, 5*6 + 3*5 + 6, 5*6 + 3*5 + 3*6, 0, 0, 6);
  dpu.dpu_func( 5*6 + 3*5 + 3*6, 0, 0, 5, 0, 6);
  dpu.dpu_func( 5*6 + 3*5 + 3*6, 5*6 + 3*5 + 3*6, 5*6 + 3*5,6, 0, 6);

  for(unsigned int k = 0; k < 32; ++k) pk[k] = rho[k];
  dpu.dpu_pack(5*6 + 3*5 + 3*6, 
# 57 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp" 3 4
                       __null
# 57 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp"
                           , pk, 32, 0, 6);
  spu.shake(256, tr, 48, pk, (32 + 6*320));


  for(unsigned int k = 0; k < 32; ++k) sk[k] = rho[k];
  for(unsigned int k = 0; k < 32; ++k) sk[32 +k] = key[k];
  for(unsigned int k = 0; k < 48; ++k) sk[2*32 +k] = tr[k];
  dpu.dpu_pack(5*6, 
# 64 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp" 3 4
                       __null
# 64 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp"
                           , sk, 2*32 +48, 6, 5);
  dpu.dpu_pack(5*6 + 3*5 + 6, 
# 65 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp" 3 4
                       __null
# 65 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp"
                           , sk, 2*32 +48
                                  +5*128, 6, 6);
  dpu.dpu_pack(5*6 + 3*5, 
# 67 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp" 3 4
                       __null
# 67 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp"
                           , sk, 2*32 +48
                                  +5*128
                                  +6*128, 2, 6);
...
extern "C"
#endif
int apatb_dpu_keygen_ir(unsigned char *, unsigned char *, unsigned char *);
#ifdef __cplusplus
extern "C"
#endif
int dpu_keygen_hw_stub(unsigned char *pk, unsigned char *sk, unsigned char *seedbuf){
int _ret = dpu_keygen(pk, sk, seedbuf);
return _ret;
}
#ifdef __cplusplus
extern "C"
#endif
int apatb_dpu_keygen_sw(unsigned char *pk, unsigned char *sk, unsigned char *seedbuf){
int _ret = apatb_dpu_keygen_ir(pk, sk, seedbuf);
return _ret;
}
#endif
# 74 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp"
