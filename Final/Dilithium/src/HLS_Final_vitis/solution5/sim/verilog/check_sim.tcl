...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.dpu_keygen.autotvin_pk.dat"
         "c.dpu_keygen.autotvin_sk.dat"
         "c.dpu_keygen.autotvin_seedbuf.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.dpu_keygen.autotvout_pk.dat"
         "rtl.dpu_keygen.autotvout_sk.dat"
         "rtl.dpu_keygen.autotvout_seedbuf.dat"
         "rtl.dpu_keygen.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
