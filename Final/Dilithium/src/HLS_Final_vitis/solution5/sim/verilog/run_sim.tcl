...
if {[file isfile dpu_keygen.autotvin.dat]} {
	file delete -force dpu_keygen.autotvin.dat
}

if {[file isfile dpu_keygen.autotvout.dat]} {
	file delete -force dpu_keygen.autotvout.dat
}
