...
// ==============================================================
# 1 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/clean/ntt.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/clean/ntt.cpp"
...
# 2 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/clean/ntt.cpp" 2
...
# 3 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/clean/ntt.cpp" 2
...
# 8 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/clean/ntt.h"
void pqcrystals_dilithium3_ref_ntt(int32_t a[256]);


void pqcrystals_dilithium3_ref_invntt_tomont(int32_t a[256]);
# 4 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/clean/ntt.cpp" 2
...
# 5 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/clean/ntt.cpp" 2
...
# 49 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/clean/ntt.cpp"
void pqcrystals_dilithium3_ref_ntt(int32_t a[256]) {
  ...
  for(len = 128; len > 0; len >>= 1) {
    ...
    for(start = 0; start < 256; start = j + len) {
      ...
      for(j = start; j < start + len; ++j) {
        t = pqcrystals_dilithium3_ref_montgomery_reduce((int64_t)zeta * a[j + len]);
...
# 80 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/clean/ntt.cpp"
void pqcrystals_dilithium3_ref_invntt_tomont(int32_t a[256]) {
  ...
  for(len = 1; len < 256; len <<= 1) {
    for(start = 0; start < 256; start = j + len) {
      ...
      for(j = start; j < start + len; ++j) {
        ...
        a[j] = t + a[j + len];
        a[j + len] = t - a[j + len];
        a[j + len] = pqcrystals_dilithium3_ref_montgomery_reduce((int64_t)zeta * a[j + len]);
      }
    }
  }

  for(j = 0; j < 256; ++j) {
    a[j] = pqcrystals_dilithium3_ref_montgomery_reduce((int64_t)f * a[j]);
  }
}
