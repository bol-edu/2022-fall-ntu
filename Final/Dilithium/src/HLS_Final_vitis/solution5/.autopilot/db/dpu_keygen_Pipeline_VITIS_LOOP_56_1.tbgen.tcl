set moduleName dpu_keygen_Pipeline_VITIS_LOOP_56_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {dpu_keygen_Pipeline_VITIS_LOOP_56_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ seedbuf int 8 regular {array 96 { 1 3 } 1 1 }  }
	{ pk int 8 regular {array 1952 { 0 3 } 0 1 }  }
}
...
set Spec2ImplPortList { 
	...
	pk { ap_memory {  { pk_address0 mem_address 1 11 }  { pk_ce0 mem_ce 1 1 }  { pk_we0 mem_we 1 1 }  { pk_d0 mem_din 1 8 } } }
}
