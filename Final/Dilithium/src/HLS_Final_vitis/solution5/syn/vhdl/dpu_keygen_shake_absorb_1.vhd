...
attribute shreg_extract : string;
    ...
    signal empty_115_fu_216_p2 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then 
                ...
                empty_fu_76 <= empty_115_fu_216_p2;
            end if; 
        end if;
    end process;
    ...
    empty_115_fu_216_p2 <= std_logic_vector(unsigned(empty_fu_76) + unsigned(ap_const_lv4_1));
