set moduleName dpu_func_Pipeline_FUNC_MATMUL_LOOP3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {dpu_func_Pipeline_FUNC_MATMUL_LOOP3}
...
set portList { 
	...
	{ call_ret36 sc_in sc_lv 8192 signal 5 } 
...
set RtlHierarchyInfo {[
		...
		"Port" : [
			...
			{"Name" : "this_0", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					...
					{"ID" : "2", "SubInstance" : "call_ln252_write_p4_fu_153", "Port" : "this_pMem", "Inst_start_state" : "32", "Inst_end_state" : "32"}]},
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.call_ln252_write_p4_fu_153", "Parent" : "0",
		"CDFG" : "write_p4",
		"Protocol" : "ap_ctrl_hs",
