set moduleName sample_eta_Pipeline_VITIS_LOOP_417_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {sample_eta_Pipeline_VITIS_LOOP_417_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ this_s int 64 regular {array 25 { 1 3 } 1 1 }  }
	{ buf_r int 8 regular {array 168 { 0 0 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "this_s", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set Spec2ImplPortList { 
	this_s { ap_memory {  { this_s_address0 mem_address 1 5 }  { this_s_ce0 mem_ce 1 1 }  { this_s_q0 in_data 0 64 } } }
