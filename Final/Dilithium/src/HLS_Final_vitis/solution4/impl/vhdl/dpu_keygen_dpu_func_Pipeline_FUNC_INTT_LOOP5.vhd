...
attribute shreg_extract : string;
    ...
    signal icmp_ln377_reg_387 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal i_64_reg_381 : STD_LOGIC_VECTOR (2 downto 0);
    signal i_64_reg_381_pp0_iter1_reg : STD_LOGIC_VECTOR (2 downto 0);
    signal icmp_ln377_fu_234_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal idxprom_i34_fu_250_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal idxprom_i23_fu_261_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal idxprom2_i5_fu_310_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_fu_78 : STD_LOGIC_VECTOR (2 downto 0);
    signal i_65_fu_266_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_block_pp0_stage1_11001 : BOOLEAN;
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_64 : STD_LOGIC_VECTOR (2 downto 0);
    signal this_p4_31_fu_82 : STD_LOGIC_VECTOR (8191 downto 0);
    signal ap_sig_allocacmp_this_p4_31_load_1 : STD_LOGIC_VECTOR (8191 downto 0);
    signal this_p3_31_fu_86 : STD_LOGIC_VECTOR (8191 downto 0);
    signal ap_sig_allocacmp_this_p3_31_load_1 : STD_LOGIC_VECTOR (8191 downto 0);
    signal this_p2_16_fu_90 : STD_LOGIC_VECTOR (8191 downto 0);
    signal this_p1_30_fu_94 : STD_LOGIC_VECTOR (8191 downto 0);
    signal ap_block_pp0_stage1_01001 : BOOLEAN;
    signal zext_ln379_1_fu_240_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln379_fu_244_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln380_fu_255_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal zext_ln379_fu_302_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal add_ln382_fu_305_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln377_reg_387 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
                i_fu_78 <= i_65_fu_266_p2;
            end if; 
        end if;
    end process;

    this_p1_30_fu_94_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
    ...
    this_p2_16_fu_90_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
    ...
    this_p3_31_fu_86_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
    ...
    this_p4_31_fu_82_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
    ...
    add_ln379_fu_244_p2 <= std_logic_vector(unsigned(zext_ln379_1_fu_240_p1) + unsigned(ap_const_lv7_52));
    add_ln380_fu_255_p2 <= std_logic_vector(unsigned(zext_ln379_1_fu_240_p1) + unsigned(ap_const_lv7_4C));
    add_ln382_fu_305_p2 <= std_logic_vector(unsigned(zext_ln379_fu_302_p1) + unsigned(addr1));
    ...
    ap_condition_exit_pp0_iter0_stage1_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1_subdone, icmp_ln377_reg_387)
    begin
        if (((icmp_ln377_reg_387 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
    ...
    ap_enable_operation_33_assign_proc : process(icmp_ln377_fu_234_p2)
    begin
                ap_enable_operation_33 <= (icmp_ln377_fu_234_p2 = ap_const_lv1_0);
    end process;


    ap_enable_operation_37_assign_proc : process(icmp_ln377_fu_234_p2)
    begin
                ap_enable_operation_37 <= (icmp_ln377_fu_234_p2 = ap_const_lv1_0);
    end process;


    ap_enable_operation_43_assign_proc : process(icmp_ln377_reg_387)
    begin
                ap_enable_operation_43 <= (icmp_ln377_reg_387 = ap_const_lv1_0);
    end process;


    ap_enable_operation_44_assign_proc : process(icmp_ln377_reg_387)
    begin
                ap_enable_operation_44 <= (icmp_ln377_reg_387 = ap_const_lv1_0);
    end process;
    ...
    ap_sig_allocacmp_i_64_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, i_fu_78, ap_loop_init)
    begin
    ...
    ap_sig_allocacmp_this_p3_31_load_1_assign_proc : process(ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage1, this_p3_ret_reg_401, ap_block_pp0_stage1, this_p3_31_fu_86)
    begin
    ...
    ap_sig_allocacmp_this_p4_31_load_1_assign_proc : process(ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage1, this_p4_ret_reg_407, ap_block_pp0_stage1, this_p4_31_fu_82)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
    ...
    grp_dpu_unit_fu_2995_p_din3 <= ap_sig_allocacmp_this_p3_31_load_1;
    grp_dpu_unit_fu_2995_p_din4 <= ap_sig_allocacmp_this_p4_31_load_1;
    grp_dpu_unit_fu_2995_p_din5 <= ap_const_lv8_1;
    i_65_fu_266_p2 <= std_logic_vector(unsigned(i_64_reg_381) + unsigned(ap_const_lv3_1));
    icmp_ln377_fu_234_p2 <= "1" when (ap_sig_allocacmp_i_64 = itr_cast) else "0";
    idxprom2_i5_fu_310_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln382_fu_305_p2),64));
    idxprom_i23_fu_261_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln380_fu_255_p2),64));
    idxprom_i34_fu_250_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln379_fu_244_p2),64));
    this_p1_30_out <= this_p1_30_fu_94;

    this_p1_30_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage1, icmp_ln377_reg_387, ap_block_pp0_stage1_11001)
    begin
        if (((icmp_ln377_reg_387 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
            this_p1_30_out_ap_vld <= ap_const_logic_1;
        else 
            this_p1_30_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    this_p2_16_out <= this_p2_16_fu_90;

    this_p2_16_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage1, icmp_ln377_reg_387, ap_block_pp0_stage1_11001)
    begin
        if (((icmp_ln377_reg_387 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
            this_p2_16_out_ap_vld <= ap_const_logic_1;
        else 
            this_p2_16_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    this_p3_31_out <= this_p3_31_fu_86;

    this_p3_31_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage1, icmp_ln377_reg_387, ap_block_pp0_stage1_11001)
    begin
        if (((icmp_ln377_reg_387 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
            this_p3_31_out_ap_vld <= ap_const_logic_1;
        else 
            this_p3_31_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;

    this_p4_31_out <= this_p4_31_fu_82;

    this_p4_31_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage1, icmp_ln377_reg_387, ap_block_pp0_stage1_11001)
    begin
        if (((icmp_ln377_reg_387 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
            this_p4_31_out_ap_vld <= ap_const_logic_1;
        else 
            this_p4_31_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;


    this_pMem_address0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1, ap_block_pp0_stage0, idxprom_i23_fu_261_p1, idxprom2_i5_fu_310_p1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then 
            this_pMem_address0 <= idxprom2_i5_fu_310_p1(8 - 1 downto 0);
        elsif (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            this_pMem_address0 <= idxprom_i23_fu_261_p1(8 - 1 downto 0);
        else 
            this_pMem_address0 <= "XXXXXXXX";
        end if; 
    end process;

    this_pMem_address1 <= idxprom_i34_fu_250_p1(8 - 1 downto 0);
    ...
    zext_ln379_1_fu_240_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_64),7));
    zext_ln379_fu_302_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_64_reg_381_pp0_iter1_reg),8));
end behav;
