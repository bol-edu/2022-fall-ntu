...
module dpu_keygen_dpu_func_Pipeline_FUNC_NTT_LOOP4 (
        ...
        addr1,
        this_p1_22_out,
        this_p1_22_out_ap_vld,
        this_p2_11_out,
        this_p2_11_out_ap_vld,
        this_p3_23_out,
        this_p3_23_out_ap_vld,
        this_p4_23_out,
        this_p4_23_out_ap_vld,
...
output   ap_idle;
output   ap_ready;
input  [8191:0] this_p1_21_reload;
input  [8191:0] this_pMem_load_25;
input  [8191:0] this_p3_22_reload;
input  [8191:0] this_p4_22_reload;
input  [2:0] itr_cast;
...
input  [7:0] addr1;
output  [8191:0] this_p1_22_out;
output   this_p1_22_out_ap_vld;
output  [8191:0] this_p2_11_out;
output   this_p2_11_out_ap_vld;
output  [8191:0] this_p3_23_out;
output   this_p3_23_out_ap_vld;
output  [8191:0] this_p4_23_out;
output   this_p4_23_out_ap_vld;
...
reg this_pMem_ce1;
reg this_p1_22_out_ap_vld;
reg this_p2_11_out_ap_vld;
reg this_p3_23_out_ap_vld;
reg this_p4_23_out_ap_vld;
...
reg   [2:0] i_42_reg_381;
reg   [2:0] i_42_reg_381_pp0_iter1_reg;
wire   [0:0] icmp_ln320_fu_234_p2;
...
wire   [63:0] idxprom_i288_fu_250_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] idxprom_i277_fu_261_p1;
wire   [63:0] idxprom2_i257_fu_310_p1;
reg   [2:0] i_fu_78;
wire   [2:0] i_43_fu_266_p2;
wire    ap_block_pp0_stage1_11001;
wire    ap_loop_init;
reg   [2:0] ap_sig_allocacmp_i_42;
reg   [8191:0] this_p4_23_fu_82;
reg   [8191:0] ap_sig_allocacmp_this_p4_23_load_1;
reg   [8191:0] this_p3_23_fu_86;
reg   [8191:0] ap_sig_allocacmp_this_p3_23_load_1;
reg   [8191:0] this_p2_11_fu_90;
reg   [8191:0] this_p1_22_fu_94;
wire    ap_block_pp0_stage1_01001;
wire   [6:0] zext_ln322_1_fu_240_p1;
wire   [6:0] add_ln322_fu_244_p2;
wire   [6:0] add_ln323_fu_255_p2;
wire   [7:0] zext_ln322_fu_302_p1;
wire   [7:0] add_ln325_fu_305_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        i_fu_78 <= 3'd0;
    end else if (((icmp_ln320_reg_387 == 1'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((icmp_ln320_reg_387 == 1'd1) & (1'b0 == ap_block_pp0_stage1_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((icmp_ln320_reg_387 == 1'd1) & (1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        this_p1_22_out_ap_vld = 1'b1;
    end else begin
        this_p1_22_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln320_reg_387 == 1'd1) & (1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        this_p2_11_out_ap_vld = 1'b1;
    end else begin
        this_p2_11_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln320_reg_387 == 1'd1) & (1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        this_p3_23_out_ap_vld = 1'b1;
    end else begin
        this_p3_23_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((icmp_ln320_reg_387 == 1'd1) & (1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        this_p4_23_out_ap_vld = 1'b1;
    end else begin
        this_p4_23_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        this_pMem_address0 = idxprom2_i257_fu_310_p1;
    end else if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        this_pMem_address0 = idxprom_i277_fu_261_p1;
    end else begin
...
assign add_ln322_fu_244_p2 = ($signed(zext_ln322_1_fu_240_p1) + $signed(7'd82));

assign add_ln323_fu_255_p2 = ($signed(zext_ln322_1_fu_240_p1) + $signed(7'd76));

assign add_ln325_fu_305_p2 = (zext_ln322_fu_302_p1 + addr1);
...
always @ (*) begin
    ap_enable_operation_33 = (icmp_ln320_fu_234_p2 == 1'd0);
end

always @ (*) begin
    ap_enable_operation_37 = (icmp_ln320_fu_234_p2 == 1'd0);
end

always @ (*) begin
    ap_enable_operation_43 = (icmp_ln320_reg_387 == 1'd0);
end

always @ (*) begin
    ap_enable_operation_44 = (icmp_ln320_reg_387 == 1'd0);
end
...
assign grp_dpu_unit_fu_2995_p_din3 = ap_sig_allocacmp_this_p3_23_load_1;

assign grp_dpu_unit_fu_2995_p_din4 = ap_sig_allocacmp_this_p4_23_load_1;

assign grp_dpu_unit_fu_2995_p_din5 = 8'd1;

assign i_43_fu_266_p2 = (i_42_reg_381 + 3'd1);

assign icmp_ln320_fu_234_p2 = ((ap_sig_allocacmp_i_42 == itr_cast) ? 1'b1 : 1'b0);

assign idxprom2_i257_fu_310_p1 = add_ln325_fu_305_p2;

assign idxprom_i277_fu_261_p1 = add_ln323_fu_255_p2;

assign idxprom_i288_fu_250_p1 = add_ln322_fu_244_p2;

assign this_p1_22_out = this_p1_22_fu_94;

assign this_p2_11_out = this_p2_11_fu_90;

assign this_p3_23_out = this_p3_23_fu_86;

assign this_p4_23_out = this_p4_23_fu_82;

assign this_pMem_address1 = idxprom_i288_fu_250_p1;

assign this_pMem_d0 = this_p3_ret_reg_401;

assign zext_ln322_1_fu_240_p1 = ap_sig_allocacmp_i_42;

assign zext_ln322_fu_302_p1 = i_42_reg_381_pp0_iter1_reg;
