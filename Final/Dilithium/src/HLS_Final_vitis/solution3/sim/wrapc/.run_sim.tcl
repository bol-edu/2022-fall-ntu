...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "dpu_keygen.autotvin.dat"
	set constFileTvOut       "dpu_keygen.autotvout.dat"
	set constFileHdlTvIn     "dpu_keygen.autohdltvin.dat"
	set constFileHdlTvOut    "dpu_keygen.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
