...
public:
    ...
    void sample_cp(int32_t *c, const uint8_t seed[32]);
};
...
#pragma HLS BIND_STORAGE variable=dpu.pMem type=ram_t2p
  int32_t tmp1[256], tmp2[256], tmp3[256];
  uint8_t tr[48];
  ...
  for(unsigned int k = 0; k < 6; ++k){
    for(unsigned int p = 0; p < 5; ++p){
      spu.sample_uniform(tmp1, rho, (k << 8) + p);
      dpu.write_Mem(tmp1, 0 +5*k+p);
    }
  }
  for(unsigned int k = 0; k < 5; ++k){
    spu.sample_eta(tmp2, rhoprime, k);
    dpu.write_Mem(tmp2, 5*6 + 5 +k);
    dpu.write_Mem(tmp2, 5*6 +k);
  }
  for(unsigned int k = 0; k < 6; ++k){
    spu.sample_eta(tmp3, rhoprime, 5 +k);
    dpu.write_Mem(tmp3, 5*6 + 3*5 + 6 +k);
  }
...
# 56 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp" 3 4
                       __null
# 56 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp"
                           , pk, 32, 0, 6);
  ...
  dpu.dpu_pack(5*6, 
# 63 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp" 3 4
                       __null
# 63 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp"
                           , sk, 2*32 +48, 6, 5);
...
# 66 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp" 3 4
                       __null
# 66 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp"
                           , sk, 2*32 +48
                                  +5*128
                                  +6*128, 2, 6);
...
#endif
# 73 "C:/Users/user/Desktop/HLS/HLS_Final_vitis_src/wrapper.cpp"
