...
attribute shreg_extract : string;
    ...
    signal i_34_reg_293 : STD_LOGIC_VECTOR (2 downto 0);
    signal icmp_ln157_reg_298 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln159_1_fu_212_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal zext_ln159_1_reg_302 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_CS_fsm_pp0_stage1 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage1 : signal is "none";
    signal ap_block_state2_pp0_stage1_iter0 : BOOLEAN;
    signal ap_block_pp0_stage1_11001 : BOOLEAN;
    signal this_3_ret7_reg_308 : STD_LOGIC_VECTOR (8191 downto 0);
    signal ap_block_pp0_stage3_11001 : BOOLEAN;
    signal this_4_ret7_reg_314 : STD_LOGIC_VECTOR (8191 downto 0);
    ...
    signal call_ln161_write_p3_fu_155_ap_start : STD_LOGIC;
    signal call_ln161_write_p3_fu_155_ap_ready : STD_LOGIC;
    signal call_ln161_write_p3_fu_155_this_pMem_address0 : STD_LOGIC_VECTOR (7 downto 0);
    signal call_ln161_write_p3_fu_155_this_pMem_ce0 : STD_LOGIC;
    signal call_ln161_write_p3_fu_155_this_pMem_we0 : STD_LOGIC_VECTOR (1023 downto 0);
    signal call_ln161_write_p3_fu_155_this_pMem_d0 : STD_LOGIC_VECTOR (8191 downto 0);
    signal grp_read_p1_fu_137_ap_start_reg : STD_LOGIC := '0';
    signal ap_block_pp0_stage1 : BOOLEAN;
    signal ap_block_pp0_stage2 : BOOLEAN;
    signal call_ln161_write_p3_fu_155_ap_start_reg : STD_LOGIC := '0';
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal i_fu_70 : STD_LOGIC_VECTOR (2 downto 0);
    signal i_35_fu_192_p2 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal zext_ln159_fu_203_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln159_fu_206_p2 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    call_ln161_write_p3_fu_155 : component dpu_keygen_write_p3
    port map (
    ...
    call_ln161_write_p3_fu_155_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                call_ln161_write_p3_fu_155_ap_start_reg <= ap_const_logic_0;
            else
                if (((ap_const_boolean_0 = ap_block_pp0_stage3_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3))) then 
                    call_ln161_write_p3_fu_155_ap_start_reg <= ap_const_logic_1;
                elsif (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (call_ln161_write_p3_fu_155_ap_ready = ap_const_logic_1))) then 
                    call_ln161_write_p3_fu_155_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((icmp_ln157_fu_186_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln157_fu_186_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln157_reg_298 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln157_reg_298 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage3_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln157_reg_298 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
                    zext_ln159_1_reg_302(6 downto 0) <= zext_ln159_1_fu_212_p1(6 downto 0);
            end if;
        end if;
    end process;
    zext_ln159_1_reg_302(7) <= '0';
    ...
    add_ln159_fu_206_p2 <= std_logic_vector(unsigned(zext_ln159_fu_203_p1) + unsigned(ap_const_lv7_4C));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln157_fu_186_p2)
    begin
        if (((icmp_ln157_fu_186_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    call_ln161_write_p3_fu_155_ap_start <= call_ln161_write_p3_fu_155_ap_start_reg;
    ...
    grp_dpu_unit_fu_2908_p_din2 <= call_ret7;
    grp_dpu_unit_fu_2908_p_din3 <= this_3_2_fu_82;
    grp_dpu_unit_fu_2908_p_din4 <= this_4_2_fu_78;
    grp_dpu_unit_fu_2908_p_din5 <= ap_const_lv8_2;
    grp_read_p1_fu_137_addr <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln159_fu_206_p2),8));
    grp_read_p1_fu_137_ap_start <= grp_read_p1_fu_137_ap_start_reg;
    i_35_fu_192_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_34) + unsigned(ap_const_lv3_1));
    icmp_ln157_fu_186_p2 <= "1" when (ap_sig_allocacmp_i_34 = itr_cast) else "0";

    this_0_address0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, icmp_ln157_reg_298, ap_CS_fsm_pp0_stage1, grp_read_p1_fu_137_this_pMem_address0, ap_CS_fsm_pp0_stage2, call_ln161_write_p3_fu_155_this_pMem_address0, ap_block_pp0_stage1, ap_block_pp0_stage2, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            this_0_address0 <= call_ln161_write_p3_fu_155_this_pMem_address0;
        elsif ((((icmp_ln157_reg_298 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2)) or ((icmp_ln157_reg_298 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1)))) then 
    ...
    this_0_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, icmp_ln157_reg_298, ap_CS_fsm_pp0_stage1, grp_read_p1_fu_137_this_pMem_ce0, ap_CS_fsm_pp0_stage2, call_ln161_write_p3_fu_155_this_pMem_ce0, ap_block_pp0_stage1, ap_block_pp0_stage2, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    this_0_d0 <= call_ln161_write_p3_fu_155_this_pMem_d0;

    this_0_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, call_ln161_write_p3_fu_155_this_pMem_we0, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    this_1_2_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln157_fu_186_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln157_fu_186_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    this_3_2_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln157_fu_186_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln157_fu_186_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    this_4_2_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln157_fu_186_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln157_fu_186_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    zext_ln159_1_fu_212_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln159_fu_206_p2),8));
    zext_ln159_fu_203_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_34_reg_293),7));
end behav;
