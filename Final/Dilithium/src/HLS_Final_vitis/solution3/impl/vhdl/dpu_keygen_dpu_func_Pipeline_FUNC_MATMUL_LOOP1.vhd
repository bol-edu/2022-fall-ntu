...
attribute shreg_extract : string;
    ...
    signal addr2_cast_cast_cast_fu_206_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal addr2_cast_cast_cast_reg_373 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal i_reg_378 : STD_LOGIC_VECTOR (2 downto 0);
    signal icmp_ln215_reg_383 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln217_1_fu_259_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal add_ln217_1_reg_387 : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_read_p1_fu_165_ap_return : STD_LOGIC_VECTOR (8191 downto 0);
    signal call_ret_reg_392 : STD_LOGIC_VECTOR (8191 downto 0);
    signal ap_CS_fsm_pp0_stage2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage2 : signal is "none";
    signal ap_block_state3_pp0_stage2_iter0 : BOOLEAN;
    signal ap_block_pp0_stage2_11001 : BOOLEAN;
    signal zext_ln217_1_fu_270_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal zext_ln217_1_reg_398 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_CS_fsm_pp0_stage3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage3 : signal is "none";
    signal ap_block_state4_pp0_stage3_iter0 : BOOLEAN;
    signal ap_block_pp0_stage3_11001 : BOOLEAN;
    signal this_3_ret9_reg_404 : STD_LOGIC_VECTOR (8191 downto 0);
    ...
    signal call_ln220_write_p3_fu_190_ap_start : STD_LOGIC;
    signal call_ln220_write_p3_fu_190_ap_ready : STD_LOGIC;
    signal call_ln220_write_p3_fu_190_this_pMem_address0 : STD_LOGIC_VECTOR (7 downto 0);
    signal call_ln220_write_p3_fu_190_this_pMem_ce0 : STD_LOGIC;
    signal call_ln220_write_p3_fu_190_this_pMem_we0 : STD_LOGIC_VECTOR (1023 downto 0);
    signal call_ln220_write_p3_fu_190_this_pMem_d0 : STD_LOGIC_VECTOR (8191 downto 0);
    signal call_ln220_write_p3_fu_190_addr : STD_LOGIC_VECTOR (7 downto 0);
    signal call_ln221_write_p4_fu_198_ap_start : STD_LOGIC;
    signal call_ln221_write_p4_fu_198_ap_ready : STD_LOGIC;
    signal call_ln221_write_p4_fu_198_this_pMem_address0 : STD_LOGIC_VECTOR (7 downto 0);
    signal call_ln221_write_p4_fu_198_this_pMem_ce0 : STD_LOGIC;
    signal call_ln221_write_p4_fu_198_this_pMem_we0 : STD_LOGIC_VECTOR (1023 downto 0);
    signal call_ln221_write_p4_fu_198_this_pMem_d0 : STD_LOGIC_VECTOR (8191 downto 0);
    signal call_ln221_write_p4_fu_198_addr : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal call_ln220_write_p3_fu_190_ap_start_reg : STD_LOGIC := '0';
    signal ap_block_pp0_stage6 : BOOLEAN;
    signal call_ln221_write_p4_fu_198_ap_start_reg : STD_LOGIC := '0';
    signal ap_block_pp0_stage6_11001 : BOOLEAN;
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal i_48_fu_86 : STD_LOGIC_VECTOR (2 downto 0);
    signal i_63_fu_243_p2 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal zext_ln217_2_cast_fu_210_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal add_ln217_fu_253_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal zext_ln217_fu_249_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal add_ln218_fu_273_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_block_pp0_stage5 : BOOLEAN;
    signal add_ln220_fu_299_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln221_fu_317_p2 : STD_LOGIC_VECTOR (6 downto 0);
...
begin
    ...
    call_ln220_write_p3_fu_190 : component dpu_keygen_write_p3
    port map (
    ...
    call_ln221_write_p4_fu_198 : component dpu_keygen_write_p4
    port map (
    ...
    call_ln220_write_p3_fu_190_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                call_ln220_write_p3_fu_190_ap_start_reg <= ap_const_logic_0;
            else
                if (((icmp_ln215_reg_383 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage5_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage5))) then 
                    call_ln220_write_p3_fu_190_ap_start_reg <= ap_const_logic_1;
                elsif (((ap_const_boolean_0 = ap_block_pp0_stage6_subdone) and (call_ln220_write_p3_fu_190_ap_ready = ap_const_logic_1))) then 
                    call_ln220_write_p3_fu_190_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    call_ln221_write_p4_fu_198_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                call_ln221_write_p4_fu_198_ap_start_reg <= ap_const_logic_0;
            else
                if (((ap_const_boolean_0 = ap_block_pp0_stage6_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage6))) then 
                    call_ln221_write_p4_fu_198_ap_start_reg <= ap_const_logic_1;
                elsif (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (call_ln221_write_p4_fu_198_ap_ready = ap_const_logic_1))) then 
                    call_ln221_write_p4_fu_198_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((icmp_ln215_fu_237_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((icmp_ln215_reg_383 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((icmp_ln215_reg_383 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage6_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage6))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln215_fu_237_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                    addr2_cast_cast_cast_reg_373(5 downto 0) <= addr2_cast_cast_cast_fu_206_p1(5 downto 0);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln215_reg_383 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage2_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln215_reg_383 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage5_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage5))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln215_reg_383 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage3_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3))) then
                    zext_ln217_1_reg_398(2 downto 0) <= zext_ln217_1_fu_270_p1(2 downto 0);
            end if;
        end if;
    end process;
    addr2_cast_cast_cast_reg_373(6) <= '0';
    zext_ln217_1_reg_398(6 downto 3) <= "0000";
    ...
    add_ln217_1_fu_259_p2 <= std_logic_vector(unsigned(add_ln217_fu_253_p2) + unsigned(zext_ln217_fu_249_p1));
    add_ln217_fu_253_p2 <= std_logic_vector(unsigned(zext_ln217_2_cast_fu_210_p1) + unsigned(addr1));
    add_ln218_fu_273_p2 <= std_logic_vector(unsigned(zext_ln217_1_fu_270_p1) + unsigned(addr2_cast_cast_cast_reg_373));
    add_ln220_fu_299_p2 <= std_logic_vector(unsigned(zext_ln217_1_reg_398) + unsigned(ap_const_lv7_4C));
    add_ln221_fu_317_p2 <= std_logic_vector(unsigned(zext_ln217_1_reg_398) + unsigned(ap_const_lv7_52));
    addr2_cast_cast_cast_fu_206_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(addr2_cast_cast),7));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln215_fu_237_p2)
    begin
        if (((icmp_ln215_fu_237_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    call_ln220_write_p3_fu_190_addr <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln220_fu_299_p2),8));
    call_ln220_write_p3_fu_190_ap_start <= call_ln220_write_p3_fu_190_ap_start_reg;
    call_ln221_write_p4_fu_198_addr <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln221_fu_317_p2),8));
    call_ln221_write_p4_fu_198_ap_start <= call_ln221_write_p4_fu_198_ap_start_reg;

    grp_dpu_unit_fu_179_ap_ce_assign_proc : process(ap_CS_fsm_pp0_stage5, ap_block_pp0_stage4_11001_ignoreCallOp50, ap_CS_fsm_pp0_stage4, ap_block_pp0_stage5_11001_ignoreCallOp51)
    begin
        if ((((ap_const_boolean_0 = ap_block_pp0_stage5_11001_ignoreCallOp51) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage5)) or ((ap_const_boolean_0 = ap_block_pp0_stage4_11001_ignoreCallOp50) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage4)))) then 
    ...
    grp_dpu_unit_fu_2908_p_ce <= grp_dpu_unit_fu_179_ap_ce;
    grp_dpu_unit_fu_2908_p_din1 <= call_ret_reg_392;
    grp_dpu_unit_fu_2908_p_din2 <= grp_read_p2_fu_172_ap_return;
    grp_dpu_unit_fu_2908_p_din3 <= this_3_10_fu_98;
    grp_dpu_unit_fu_2908_p_din4 <= this_4_10_fu_94;
    grp_dpu_unit_fu_2908_p_din5 <= ap_const_lv8_2;
    grp_read_p1_fu_165_ap_start <= grp_read_p1_fu_165_ap_start_reg;
    grp_read_p2_fu_172_addr <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln218_fu_273_p2),8));
    grp_read_p2_fu_172_ap_start <= grp_read_p2_fu_172_ap_start_reg;
    i_63_fu_243_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i) + unsigned(ap_const_lv3_1));
    icmp_ln215_fu_237_p2 <= "1" when (ap_sig_allocacmp_i = itr_cast) else "0";

    this_0_address0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage6, icmp_ln215_reg_383, ap_CS_fsm_pp0_stage2, ap_CS_fsm_pp0_stage3, grp_read_p1_fu_165_this_pMem_address0, grp_read_p2_fu_172_this_pMem_address0, ap_CS_fsm_pp0_stage4, call_ln220_write_p3_fu_190_this_pMem_address0, call_ln221_write_p4_fu_198_this_pMem_address0, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1, ap_block_pp0_stage2, ap_block_pp0_stage3, ap_block_pp0_stage4, ap_block_pp0_stage6, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            this_0_address0 <= call_ln221_write_p4_fu_198_this_pMem_address0;
        elsif (((icmp_ln215_reg_383 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage6) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage6))) then 
            this_0_address0 <= call_ln220_write_p3_fu_190_this_pMem_address0;
        elsif ((((icmp_ln215_reg_383 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage4) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage4)) or ((icmp_ln215_reg_383 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage3) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage3)))) then 
            this_0_address0 <= grp_read_p2_fu_172_this_pMem_address0;
        elsif ((((icmp_ln215_reg_383 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2)) or ((icmp_ln215_reg_383 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1)))) then 
    ...
    this_0_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage6, icmp_ln215_reg_383, ap_CS_fsm_pp0_stage2, ap_CS_fsm_pp0_stage3, grp_read_p1_fu_165_this_pMem_ce0, grp_read_p2_fu_172_this_pMem_ce0, ap_CS_fsm_pp0_stage4, call_ln220_write_p3_fu_190_this_pMem_ce0, call_ln221_write_p4_fu_198_this_pMem_ce0, ap_CS_fsm_pp0_stage1, ap_block_pp0_stage1, ap_block_pp0_stage2, ap_block_pp0_stage3, ap_block_pp0_stage4, ap_block_pp0_stage6, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    this_0_d0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage6, icmp_ln215_reg_383, call_ln220_write_p3_fu_190_this_pMem_d0, call_ln221_write_p4_fu_198_this_pMem_d0, ap_block_pp0_stage6, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    this_0_we0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter1, ap_CS_fsm_pp0_stage6, icmp_ln215_reg_383, call_ln220_write_p3_fu_190_this_pMem_we0, call_ln221_write_p4_fu_198_this_pMem_we0, ap_block_pp0_stage6, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    this_1_10_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln215_fu_237_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln215_fu_237_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    this_3_10_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln215_fu_237_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln215_fu_237_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    this_4_10_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln215_fu_237_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln215_fu_237_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    zext_ln217_1_fu_270_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_reg_378),7));
    zext_ln217_2_cast_fu_210_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln217_2),8));
    zext_ln217_fu_249_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i),8));
end behav;
