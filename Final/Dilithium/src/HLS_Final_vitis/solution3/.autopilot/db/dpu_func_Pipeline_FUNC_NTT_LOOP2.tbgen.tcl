...
set C_modelArgMapList {[ 
	{ "Name" : "this_3_20_reload", "interface" : "wire", "bitwidth" : 8192, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "call_ret26", "interface" : "wire", "bitwidth" : 8192, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ call_ret26 sc_in sc_lv 8192 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "call_ret26", "direction": "in", "datatype": "sc_lv", "bitwidth":8192, "type": "signal", "bundle":{"name": "call_ret26", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			...
			{"Name" : "this_0", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "call_ln302_write_p3_fu_155", "Port" : "this_pMem", "Inst_start_state" : "5", "Inst_end_state" : "5"},
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.call_ln302_write_p3_fu_155", "Parent" : "0",
		"CDFG" : "write_p3",
		"Protocol" : "ap_ctrl_hs",
...
set Spec2ImplPortList { 
	...
	call_ret26 { ap_none {  { call_ret26 in_data 0 8192 } } }
