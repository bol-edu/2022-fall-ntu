...
set C_modelArgMapList {[ 
	{ "Name" : "this_3_30_reload", "interface" : "wire", "bitwidth" : 8192, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "call_ret45", "interface" : "wire", "bitwidth" : 8192, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "this_4_31_out", "interface" : "wire", "bitwidth" : 8192, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ call_ret45 sc_in sc_lv 8192 signal 3 } 
	...
	{ this_4_31_out sc_out sc_lv 8192 signal 8 } 
	{ this_4_31_out_ap_vld sc_out sc_logic 1 outvld 8 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "call_ret45", "direction": "in", "datatype": "sc_lv", "bitwidth":8192, "type": "signal", "bundle":{"name": "call_ret45", "role": "default" }} , 
 	...
 	{ "name": "this_4_31_out", "direction": "out", "datatype": "sc_lv", "bitwidth":8192, "type": "signal", "bundle":{"name": "this_4_31_out", "role": "default" }} , 
 	{ "name": "this_4_31_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "this_4_31_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
		...
		"Port" : [
			...
			{"Name" : "this_0", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					...
					{"ID" : "3", "SubInstance" : "call_ln377_write_p3_fu_189", "Port" : "this_pMem", "Inst_start_state" : "7", "Inst_end_state" : "7"}]},
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_read_p2_fu_171", "Parent" : "0",
		...
		"Port" : [
			{"Name" : "this_pMem", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "addr", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.call_ln377_write_p3_fu_189", "Parent" : "0",
		"CDFG" : "write_p3",
		"Protocol" : "ap_ctrl_hs",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "32", "Max" : "38"}
	, {"Name" : "Interval", "Min" : "32", "Max" : "38"}
]}
...
set Spec2ImplPortList { 
	...
	call_ret45 { ap_none {  { call_ret45 in_data 0 8192 } } }
	...
	this_4_31_out { ap_vld {  { this_4_31_out out_data 1 8192 }  { this_4_31_out_ap_vld out_vld 1 1 } } }
