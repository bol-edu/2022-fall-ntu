...
set C_modelArgMapList {[ 
	{ "Name" : "this_3_27_reload", "interface" : "wire", "bitwidth" : 8192, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "call_ret16", "interface" : "wire", "bitwidth" : 8192, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ call_ret16 sc_in sc_lv 8192 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "call_ret16", "direction": "in", "datatype": "sc_lv", "bitwidth":8192, "type": "signal", "bundle":{"name": "call_ret16", "role": "default" }} , 
...
set RtlHierarchyInfo {[
		...
		"Port" : [
			...
			{"Name" : "this_0", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					...
					{"ID" : "2", "SubInstance" : "call_ln349_write_p3_fu_169", "Port" : "this_pMem", "Inst_start_state" : "5", "Inst_end_state" : "5"},
					{"ID" : "3", "SubInstance" : "call_ln350_write_p4_fu_177", "Port" : "this_pMem", "Inst_start_state" : "6", "Inst_end_state" : "6"}]},
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.call_ln349_write_p3_fu_169", "Parent" : "0",
		"CDFG" : "write_p3",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "addr", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.call_ln350_write_p4_fu_177", "Parent" : "0",
		"CDFG" : "write_p4",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
...
set Spec2ImplPortList { 
	...
	call_ret16 { ap_none {  { call_ret16 in_data 0 8192 } } }
