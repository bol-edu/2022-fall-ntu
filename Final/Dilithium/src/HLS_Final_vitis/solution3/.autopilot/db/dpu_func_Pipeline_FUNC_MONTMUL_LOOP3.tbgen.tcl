...
set portList { 
	...
	{ call_ret19 sc_in sc_lv 8192 signal 5 } 
...
set RtlHierarchyInfo {[
		...
		"Port" : [
			...
			{"Name" : "this_0", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					...
					{"ID" : "2", "SubInstance" : "call_ln199_write_p4_fu_155", "Port" : "this_pMem", "Inst_start_state" : "5", "Inst_end_state" : "5"}]},
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.call_ln199_write_p4_fu_155", "Parent" : "0",
		"CDFG" : "write_p4",
		"Protocol" : "ap_ctrl_hs",
