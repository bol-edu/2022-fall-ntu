# 1 "HLS_Final_vitis_src/wrapper.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 395 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "HLS_Final_vitis_src/wrapper.cpp" 2
...
# 2 "HLS_Final_vitis_src/wrapper.cpp" 2
# 1 "Z:/Xilinx/Vitis_HLS/2022.1/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 1 3
# 11 "Z:/Xilinx/Vitis_HLS/2022.1/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\stdio.h" 3
...
# 3 "HLS_Final_vitis_src/wrapper.cpp" 2
...
# 4 "HLS_Final_vitis_src/wrapper.cpp" 2
# 1 "HLS_Final_vitis_src/dpu.h" 1
# 91 "HLS_Final_vitis_src/dpu.h"
class DPU
{
private:
public:
...
# 5 "HLS_Final_vitis_src/wrapper.cpp" 2
...
# 6 "HLS_Final_vitis_src/wrapper.cpp" 2
# 1 "HLS_Final_vitis_src/wrapper.h" 1



# 1 "Z:\\Xilinx\\Vitis_HLS\\2022.1\\win64\\tools\\clang-3.9-csynth\\lib\\clang\\7.0.0\\include\\stddef.h" 1 3
# 51 "Z:\\Xilinx\\Vitis_HLS\\2022.1\\win64\\tools\\clang-3.9-csynth\\lib\\clang\\7.0.0\\include\\stddef.h" 3
typedef long int ptrdiff_t;
# 62 "Z:\\Xilinx\\Vitis_HLS\\2022.1\\win64\\tools\\clang-3.9-csynth\\lib\\clang\\7.0.0\\include\\stddef.h" 3
typedef long unsigned int size_t;
# 118 "Z:\\Xilinx\\Vitis_HLS\\2022.1\\win64\\tools\\clang-3.9-csynth\\lib\\clang\\7.0.0\\include\\stddef.h" 3
# 1 "Z:\\Xilinx\\Vitis_HLS\\2022.1\\win64\\tools\\clang-3.9-csynth\\lib\\clang\\7.0.0\\include/__stddef_max_align_t.h" 1 3
# 35 "Z:\\Xilinx\\Vitis_HLS\\2022.1\\win64\\tools\\clang-3.9-csynth\\lib\\clang\\7.0.0\\include/__stddef_max_align_t.h" 3
typedef struct {
...
# 119 "Z:\\Xilinx\\Vitis_HLS\\2022.1\\win64\\tools\\clang-3.9-csynth\\lib\\clang\\7.0.0\\include\\stddef.h" 2 3
# 5 "HLS_Final_vitis_src/wrapper.h" 2



__attribute__((sdx_kernel("dpu_keygen", 0))) int dpu_keygen(uint8_t pk[(32 + 6*320)], uint8_t sk[(2*32 + 48 + 5*128 + 6*128 + 6*416)], uint8_t seedbuf[3*32]);
# 7 "HLS_Final_vitis_src/wrapper.cpp" 2

__attribute__((sdx_kernel("dpu_keygen", 0))) int dpu_keygen(uint8_t pk[(32 + 6*320)], uint8_t sk[(2*32 + 48 + 5*128 + 6*128 + 6*416)], uint8_t seedbuf[3*32]) {
#line 46 "C:/Users/user/Desktop/HLS/HLS_final_vitis/solution3/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=dpu_keygen
# 8 "HLS_Final_vitis_src/wrapper.cpp"

#line 6 "C:/Users/user/Desktop/HLS/HLS_final_vitis/solution3/directives.tcl"
#pragma HLSDIRECTIVE TOP name=dpu_keygen
# 8 "HLS_Final_vitis_src/wrapper.cpp"
...
#pragma HLS BIND_STORAGE variable=dpu.pMem type=ram_t2p
 int32_t tmp1[256], tmp2[256], tmp3[256];
  ...
  VITIS_LOOP_31_1: for(unsigned int k = 0; k < 6; ++k){
    VITIS_LOOP_32_2: for(unsigned int p = 0; p < 5; ++p){
      spu.sample_uniform(tmp1, rho, (k << 8) + p);
      dpu.write_Mem(tmp1, 0 +5*k+p);
    }
  }
  VITIS_LOOP_37_3: for(unsigned int k = 0; k < 5; ++k){
    spu.sample_eta(tmp2, rhoprime, k);
    dpu.write_Mem(tmp2, 5*6 + 5 +k);
    dpu.write_Mem(tmp2, 5*6 +k);
  }
  VITIS_LOOP_42_4: for(unsigned int k = 0; k < 6; ++k){
  ...
  VITIS_LOOP_55_5: for(unsigned int k = 0; k < 32; ++k) pk[k] = rho[k];
  dpu.dpu_pack(5*6 + 3*5 + 3*6, 0, pk, 32, 0, 6);
  spu.shake(256, tr, 48, pk, (32 + 6*320));


  VITIS_LOOP_60_6: for(unsigned int k = 0; k < 32; ++k) sk[k] = rho[k];
  VITIS_LOOP_61_7: for(unsigned int k = 0; k < 32; ++k) sk[32 +k] = key[k];
  VITIS_LOOP_62_8: for(unsigned int k = 0; k < 48; ++k) sk[2*32 +k] = tr[k];
  dpu.dpu_pack(5*6, 0, sk, 2*32 +48, 6, 5);
  dpu.dpu_pack(5*6 + 3*5 + 6, 0, sk, 2*32 +48
                                  +5*128, 6, 6);
  dpu.dpu_pack(5*6 + 3*5, 0, sk, 2*32 +48
                                  +5*128
                                  +6*128, 2, 6);
