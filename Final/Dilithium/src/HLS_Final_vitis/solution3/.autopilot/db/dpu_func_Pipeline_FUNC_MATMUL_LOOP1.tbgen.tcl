...
set C_modelArgMapList {[ 
	{ "Name" : "this_3_9", "interface" : "wire", "bitwidth" : 8192, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "zext_ln217_2", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ zext_ln217_2 sc_in sc_lv 5 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "zext_ln217_2", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "zext_ln217_2", "role": "default" }} , 
...
set RtlHierarchyInfo {[
		...
		"Port" : [
			...
			{"Name" : "this_0", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					...
					{"ID" : "3", "SubInstance" : "call_ln220_write_p3_fu_190", "Port" : "this_pMem", "Inst_start_state" : "7", "Inst_end_state" : "7"},
					{"ID" : "1", "SubInstance" : "grp_read_p1_fu_165", "Port" : "this_pMem", "Inst_start_state" : "2", "Inst_end_state" : "3"},
					{"ID" : "4", "SubInstance" : "call_ln221_write_p4_fu_198", "Port" : "this_pMem", "Inst_start_state" : "8", "Inst_end_state" : "8"}]},
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_read_p2_fu_172", "Parent" : "0",
		...
		"Port" : [
			{"Name" : "this_pMem", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "addr", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.call_ln220_write_p3_fu_190", "Parent" : "0",
		"CDFG" : "write_p3",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			...
			{"Name" : "addr", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.call_ln221_write_p4_fu_198", "Parent" : "0",
		"CDFG" : "write_p4",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "37", "Max" : "44"}
	, {"Name" : "Interval", "Min" : "37", "Max" : "44"}
]}
...
set Spec2ImplPortList { 
	...
	zext_ln217_2 { ap_none {  { zext_ln217_2 in_data 0 5 } } }
