...
(* CORE_GENERATION_INFO="StreamingDataflowPartition_1_StreamingDataWidthConverter_Batch_17_StreamingDataflowPartition_1_StreamingDataWidthConverter_Batch_17,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.311000,HLS_SYN_LAT=6403,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=1323,HLS_SYN_LUT=263,HLS_VERSION=2022_1}" *)
...
reg   [639:0] ap_phi_mux_ei_V_3_phi_fu_86_p4;
wire   [639:0] ap_phi_reg_pp0_iter0_ei_V_3_reg_83;
reg   [639:0] ap_phi_reg_pp0_iter1_ei_V_3_reg_83;
wire   [639:0] zext_ln477_fu_167_p1;
reg   [629:0] ei_V_fu_58;
wire    ap_loop_init;
reg   [31:0] o_fu_62;
...
always @ (posedge ap_clk) begin
    if ((~(((1'b1 == ap_CS_iter2_fsm_state3) & ((regslice_both_out_V_U_apdone_blk == 1'b1) | (1'b1 == ap_block_state3_io) | ((icmp_ln477_reg_218_pp0_iter1_reg == 1'd0) & (out_V_TREADY_int_regslice == 1'b0)))) | ((1'b1 == ap_CS_iter1_fsm_state2) & ((1'b1 == ap_block_state2_io) | ((icmp_ln477_reg_218 == 1'd0) & (out_V_TREADY_int_regslice == 1'b0)))) | ((ap_predicate_op26_read_state1 == 1'b1) & (in0_V_TVALID_int_regslice == 1'b0))) & (1'b1 == ap_CS_iter0_fsm_state1) & (ap_loop_init == 1'b1))) begin
        ...
        ei_V_fu_58 <= {{ap_phi_mux_ei_V_3_phi_fu_86_p4[639:10]}};
    end
end
...
assign eo_V_fu_172_p1 = ap_phi_mux_ei_V_3_phi_fu_86_p4[9:0];

assign icmp_ln477_fu_110_p2 = ((ap_sig_allocacmp_t_1 == 13'd6400) ? 1'b1 : 1'b0);
...
assign t_2_fu_116_p2 = (ap_sig_allocacmp_t_1 + 13'd1);
