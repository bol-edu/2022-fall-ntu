...
(* CORE_GENERATION_INFO="StreamingDataflowPartition_1_FMPadding_Batch_1_StreamingDataflowPartition_1_FMPadding_Batch_1,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.622000,HLS_SYN_LAT=1159,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=190,HLS_SYN_LUT=269,HLS_VERSION=2022_1}" *)

module StreamingDataflowPartition_1_FMPadding_Batch_1 (
        ap_clk,
        ap_rst_n,
        in0_V_TVALID,
        out_V_TREADY,
...
StreamingDataflowPartition_1_FMPadding_Batch_1_flow_control_loop_pipe_no_ap_cont flow_control_loop_pipe_no_ap_cont_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .ap_start(1'b1),
    .ap_ready(ap_ready),
...
StreamingDataflowPartition_1_FMPadding_Batch_1_regslice_both #(
    .DataWidth( 160 ))
...
endmodule //StreamingDataflowPartition_1_FMPadding_Batch_1
