...
wire   [383:0] ap_phi_reg_pp0_iter0_outData_1_reg_85;
reg   [383:0] ap_phi_reg_pp0_iter1_outData_1_reg_85;
reg   [2:0] x_fu_60;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_303)) begin
        if (((or_cond_i_i_fu_225_p2 == 1'd1) & (icmp_ln279_fu_138_p2 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_outData_1_reg_85 <= 384'd0;
