...
(* CORE_GENERATION_INFO="StreamingDataflowPartition_1_FMPadding_Batch_1_StreamingDataflowPartition_1_FMPadding_Batch_1,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.622000,HLS_SYN_LAT=1159,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=126,HLS_SYN_LUT=269,HLS_VERSION=2022_1}" *)
...
wire   [95:0] ap_phi_reg_pp0_iter0_outData_1_reg_85;
reg   [95:0] ap_phi_reg_pp0_iter1_outData_1_reg_85;
reg   [5:0] x_fu_60;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_303)) begin
        if (((or_cond_i_i_fu_225_p2 == 1'd1) & (icmp_ln279_fu_138_p2 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_outData_1_reg_85 <= 96'd0;
