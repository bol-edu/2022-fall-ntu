...
(* CORE_GENERATION_INFO="StreamingDataflowPartition_1_StreamingDataWidthConverter_Batch_4_StreamingDataflowPartition_1_StreamingDataWidthConverter_Batch_4,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.311000,HLS_SYN_LAT=9251,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=234,HLS_SYN_LUT=266,HLS_VERSION=2022_1}" *)
...
assign icmp_ln477_fu_110_p2 = ((ap_sig_allocacmp_t_1 == 14'd9248) ? 1'b1 : 1'b0);
