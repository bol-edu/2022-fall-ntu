...
(* CORE_GENERATION_INFO="StreamingDataflowPartition_1_ConvolutionInputGenerator_5_StreamingDataflowPartition_1_ConvolutionInputGenerator_5,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.591000,HLS_SYN_LAT=2790,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=611,HLS_SYN_LUT=2265,HLS_VERSION=2022_1}" *)

module StreamingDataflowPartition_1_ConvolutionInputGenerator_5 (
        ap_clk,
        ap_rst_n,
        in0_V_TDATA,
        in0_V_TVALID,
...
StreamingDataflowPartition_1_ConvolutionInputGenerator_5_ConvolutionInputGenerator_kernel_stride grp_ConvolutionInputGenerator_kernel_stride_fu_28(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
StreamingDataflowPartition_1_ConvolutionInputGenerator_5_regslice_both #(
    .DataWidth( 16 ))
...
endmodule //StreamingDataflowPartition_1_ConvolutionInputGenerator_5
