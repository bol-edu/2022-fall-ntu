...
wire   [8:0] current_line_in_block_fu_557_p2;
reg   [8:0] current_line_in_block_reg_1195;
...
wire   [11:0] tmp_4_fu_747_p1;
wire   [2:0] trunc_ln484_fu_844_p1;
wire   [11:0] tmp_3_fu_826_p1;
...
wire   [8:0] shl_ln514_1_fu_549_p3;
wire   [8:0] trunc_ln478_fu_469_p1;
...
StreamingDataflowPartition_1_ConvolutionInputGenerator_1_mux_532_12_1_1 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 12 ),
    .din1_WIDTH( 12 ),
...
assign grp_fu_354_p2 = ((grp_fu_348_p2 == 32'd272) ? 1'b1 : 1'b0);
...
assign i_2_fu_457_p2 = (ap_sig_allocacmp_i_1 + 15'd1);

assign icmp_ln478_fu_451_p2 = ((ap_sig_allocacmp_i_1 == 15'd19248) ? 1'b1 : 1'b0);

assign icmp_ln480_fu_473_p2 = ((ap_sig_allocacmp_inp_load < 32'd816) ? 1'b1 : 1'b0);

assign icmp_ln499_1_fu_488_p2 = ((grp_load_fu_333_p1 == 32'd34) ? 1'b1 : 1'b0);

assign icmp_ln499_fu_482_p2 = ((ap_sig_allocacmp_counter_internal_block_load < 32'd1151) ? 1'b1 : 1'b0);
...
assign icmp_ln518_fu_569_p2 = ((count_simd_1_fu_563_p2 == 32'd8) ? 1'b1 : 1'b0);
...
assign icmp_ln539_fu_729_p2 = ((ap_sig_allocacmp_counter_internal_block_load_1 < 32'd543) ? 1'b1 : 1'b0);

assign icmp_ln558_fu_807_p2 = ((counter_internal_block_1_fu_801_p2 == 32'd1151) ? 1'b1 : 1'b0);
...
assign shl_ln514_1_fu_549_p3 = {{add_ln514_fu_543_p2}, {3'd0}};

assign tmp_3_fu_826_p1 = in0_V_TDATA[11:0];

assign tmp_4_fu_747_p1 = in0_V_TDATA[11:0];

assign trunc_ln478_fu_469_p1 = ap_sig_allocacmp_count_simd_load[8:0];
