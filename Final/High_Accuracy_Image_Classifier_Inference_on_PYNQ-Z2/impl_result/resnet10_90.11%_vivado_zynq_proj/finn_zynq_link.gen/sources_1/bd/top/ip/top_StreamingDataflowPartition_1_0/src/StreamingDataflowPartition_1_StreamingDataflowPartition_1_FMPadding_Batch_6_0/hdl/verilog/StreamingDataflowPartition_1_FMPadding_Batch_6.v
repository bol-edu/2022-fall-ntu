...
(* CORE_GENERATION_INFO="StreamingDataflowPartition_1_FMPadding_Batch_6_StreamingDataflowPartition_1_FMPadding_Batch_6,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.822000,HLS_SYN_LAT=39,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=1043,HLS_SYN_LUT=247,HLS_VERSION=2022_1}" *)
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_303)) begin
        if (((or_cond_i_i_fu_225_p2 == 1'd1) & (icmp_ln279_fu_138_p2 == 1'd0))) begin
            ap_phi_reg_pp0_iter1_outData_1_reg_85 <= 1024'd0;
...
assign add_ln279_1_fu_167_p2 = (ap_sig_allocacmp_y_1 + 3'd1);

assign add_ln279_fu_144_p2 = (ap_sig_allocacmp_indvar_flatten_load + 6'd1);
...
assign cmp10_i_i_fu_126_p2 = ((ap_sig_allocacmp_y_1 > 3'd4) ? 1'b1 : 1'b0);

assign cmp10_i_i_mid1_fu_179_p2 = ((add_ln279_1_fu_167_p2 > 3'd4) ? 1'b1 : 1'b0);

assign cmp11_i_i_fu_207_p2 = ((select_ln279_fu_159_p3 == 3'd0) ? 1'b1 : 1'b0);

assign cmp13_i_i_fu_213_p2 = ((select_ln279_fu_159_p3 > 3'd4) ? 1'b1 : 1'b0);

assign cmp9_i_i_fu_120_p2 = ((ap_sig_allocacmp_y_1 == 3'd0) ? 1'b1 : 1'b0);

assign cmp9_i_i_mid1_fu_173_p2 = ((add_ln279_1_fu_167_p2 == 3'd0) ? 1'b1 : 1'b0);

assign icmp_ln279_fu_138_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 6'd36) ? 1'b1 : 1'b0);

assign icmp_ln280_fu_153_p2 = ((ap_sig_allocacmp_x_load == 3'd6) ? 1'b1 : 1'b0);
...
assign select_ln279_fu_159_p3 = ((icmp_ln280_fu_153_p2[0:0] == 1'b1) ? 3'd0 : ap_sig_allocacmp_x_load);
...
assign x_1_fu_231_p2 = (select_ln279_fu_159_p3 + 3'd1);
