...
(* CORE_GENERATION_INFO="StreamingDataflowPartition_1_FMPadding_Batch_2_StreamingDataflowPartition_1_FMPadding_Batch_2,hls_ip_2022_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.524500,HLS_SYN_LAT=327,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=282,HLS_SYN_LUT=263,HLS_VERSION=2022_1}" *)
