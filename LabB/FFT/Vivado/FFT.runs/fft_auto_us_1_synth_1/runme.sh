...
HD_PWD='C:/Users/User/Documents/HLS/LabB/FFT/Vivado/FFT.runs/fft_auto_us_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_auto_us_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_auto_us_1.tcl
