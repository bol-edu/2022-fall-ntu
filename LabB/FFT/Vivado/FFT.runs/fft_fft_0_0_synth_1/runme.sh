...
HD_PWD='C:/Users/User/Documents/HLS/LabB/FFT/Vivado/FFT.runs/fft_fft_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fft_fft_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fft_fft_0_0.tcl
