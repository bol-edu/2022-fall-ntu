...
extern "C" void fft(int*, int*, int*, int*, int, int, int, int);
extern "C" void apatb_fft_hw(volatile void * __xlx_apatb_param_X_R, volatile void * __xlx_apatb_param_X_I, volatile void * __xlx_apatb_param_OUT_R, volatile void * __xlx_apatb_param_OUT_I) {
  ...
  // DUT call
  fft(__xlx_X_R__input_buffer, __xlx_X_I__input_buffer, __xlx_OUT_R__input_buffer, __xlx_OUT_I__input_buffer, __xlx_offset_byte_param_X_R, __xlx_offset_byte_param_X_I, __xlx_offset_byte_param_OUT_R, __xlx_offset_byte_param_OUT_I);
