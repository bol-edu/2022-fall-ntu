; ModuleID = 'C:/Users/User/Documents/HLS/LabB/FFT/HLS/1_Subcomponents/fft_stage_first/hls/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call void @apatb_fft_stage_first_hw(float* %4, float* %5, float* %6, float* %7)
...
declare void @apatb_fft_stage_first_hw(float*, float*, float*, float*)
...
define void @fft_stage_first_hw_stub_wrapper(float*, float*, float*, float*) #4 {
entry:
  ...
  call void @fft_stage_first_hw_stub(float* %8, float* %9, float* %10, float* %11)
