...
architecture behav of blockmatmul is 
    ...
    "blockmatmul,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.510000,HLS_SYN_LAT=207,HLS_SYN_TPT=208,HLS_SYN_MEM=4,HLS_SYN_DSP=12,HLS_SYN_FF=547,HLS_SYN_LUT=937,HLS_VERSION=2020_1}";
