...
architecture behav of blockmatmul is 
    ...
    "blockmatmul,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.510000,HLS_SYN_LAT=107,HLS_SYN_TPT=108,HLS_SYN_MEM=10,HLS_SYN_DSP=12,HLS_SYN_FF=745,HLS_SYN_LUT=2446,HLS_VERSION=2020_1}";
    ...
    signal AB_i_q0 : STD_LOGIC_VECTOR (127 downto 0);
    signal AB_t_q0 : STD_LOGIC_VECTOR (127 downto 0);
    signal Loop_memset_AB_proc1_U0_ap_start : STD_LOGIC;
    signal Loop_memset_AB_proc1_U0_ap_done : STD_LOGIC;
    signal Loop_memset_AB_proc1_U0_ap_continue : STD_LOGIC;
    signal Loop_memset_AB_proc1_U0_ap_idle : STD_LOGIC;
    signal Loop_memset_AB_proc1_U0_ap_ready : STD_LOGIC;
    signal Loop_memset_AB_proc1_U0_AB_address0 : STD_LOGIC_VECTOR (1 downto 0);
    signal Loop_memset_AB_proc1_U0_AB_ce0 : STD_LOGIC;
    signal Loop_memset_AB_proc1_U0_AB_we0 : STD_LOGIC;
    signal Loop_memset_AB_proc1_U0_AB_d0 : STD_LOGIC_VECTOR (127 downto 0);
    signal Loop_memset_AB_proc1_U0_AB_address1 : STD_LOGIC_VECTOR (1 downto 0);
    signal Loop_memset_AB_proc1_U0_AB_ce1 : STD_LOGIC;
    signal Loop_memset_AB_proc1_U0_AB_we1 : STD_LOGIC;
    signal Loop_memset_AB_proc1_U0_AB_d1 : STD_LOGIC_VECTOR (127 downto 0);
    signal Loop_memset_AB_proc1_U0_Arows_V_a_0_read : STD_LOGIC;
    signal Loop_memset_AB_proc1_U0_Arows_V_a_1_read : STD_LOGIC;
    signal Loop_memset_AB_proc1_U0_Arows_V_a_2_read : STD_LOGIC;
    signal Loop_memset_AB_proc1_U0_Arows_V_a_3_read : STD_LOGIC;
    signal Loop_memset_AB_proc1_U0_Bcols_V_a_0_read : STD_LOGIC;
    signal Loop_memset_AB_proc1_U0_Bcols_V_a_1_read : STD_LOGIC;
    signal Loop_memset_AB_proc1_U0_Bcols_V_a_2_read : STD_LOGIC;
    signal Loop_memset_AB_proc1_U0_Bcols_V_a_3_read : STD_LOGIC;
    signal ap_channel_done_AB : STD_LOGIC;
    signal Loop_memset_AB_proc1_U0_AB_full_n : STD_LOGIC;
    ...
    signal Loop_writeoutput_pro_U0_AB_address0 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal Loop_memset_AB_proc1_U0_start_full_n : STD_LOGIC;
    signal Loop_memset_AB_proc1_U0_start_write : STD_LOGIC;
    signal Loop_writeoutput_pro_U0_start_full_n : STD_LOGIC;
    signal Loop_writeoutput_pro_U0_start_write : STD_LOGIC;

    component Loop_memset_AB_proc1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    ...
    Loop_memset_AB_proc1_U0 : component Loop_memset_AB_proc1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Bcols_V_a_2_read <= Loop_memset_AB_proc1_U0_Bcols_V_a_2_read;
    Bcols_V_a_3_read <= Loop_memset_AB_proc1_U0_Bcols_V_a_3_read;
    Loop_memset_AB_proc1_U0_AB_full_n <= AB_i_full_n;
    Loop_memset_AB_proc1_U0_ap_continue <= AB_i_full_n;
    Loop_memset_AB_proc1_U0_ap_start <= ap_start;
    ...
    ap_channel_done_AB <= Loop_memset_AB_proc1_U0_ap_done;
    ap_done <= Loop_writeoutput_pro_U0_ap_done;
    ap_idle <= ((ap_const_logic_1 xor AB_t_empty_n) and Loop_writeoutput_pro_U0_ap_idle and Loop_memset_AB_proc1_U0_ap_idle);
    ap_ready <= Loop_memset_AB_proc1_U0_ap_ready;
    ap_sync_continue <= ap_const_logic_1;
    ap_sync_done <= Loop_writeoutput_pro_U0_ap_done;
    ap_sync_ready <= Loop_memset_AB_proc1_U0_ap_ready;
end behav;
