set moduleName Loop_memset_AB_proc1
set isTopModule 0
...
set C_modelName {Loop_memset_AB_proc1}
set C_modelType { void 0 }
set C_modelArgList {
	{ AB int 128 regular {array 4 { 2 0 } 1 1 }  }
	{ it int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "AB", "interface" : "memory", "bitwidth" : 128, "direction" : "READWRITE"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "AB_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "AB", "role": "d0" }} , 
 	{ "name": "AB_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "AB", "role": "q0" }} , 
 	...
 	{ "name": "AB_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "AB", "role": "d1" }} , 
...
set Spec2ImplPortList { 
	AB { ap_memory {  { AB_address0 mem_address 1 2 }  { AB_ce0 mem_ce 1 1 }  { AB_we0 mem_we 1 1 }  { AB_d0 mem_din 1 128 }  { AB_q0 mem_dout 0 128 }  { AB_address1 MemPortADDR2 1 2 }  { AB_ce1 MemPortCE2 1 1 }  { AB_we1 MemPortWE2 1 1 }  { AB_d1 MemPortDIN2 1 128 } } }
