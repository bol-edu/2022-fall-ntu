...
set DataType0 [list "blockvec" "struct " $structMem0 0 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set DataType1 [list "blockvec" "struct " $structMem1 0 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
set Port1 [list $PortName1 $Interface1 $DataType1 $Pointer1 $Dims1 $Const1 $Volatile1 $ArrayOpt1]
lappend PortList $Port1
set PortName2 "ABpartial"
set BitWidth2 "512"
set ArrayOpt2 ""
set Const2 "0"
set Volatile2 "0"
...
set DataType2 [list "blockmat" "struct " $structMem2 0 0 $structParameter2 $structArgument2 $NameSpace2 $structIsPacked2]
