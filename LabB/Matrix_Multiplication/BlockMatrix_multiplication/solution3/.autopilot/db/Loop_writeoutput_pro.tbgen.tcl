...
set C_modelArgList {
	{ AB int 128 regular {array 4 { 1 3 } 1 1 }  }
	{ ABpartial_out int 32 regular {array 16 { 0 0 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "AB", "interface" : "memory", "bitwidth" : 128, "direction" : "READONLY"} , 
...
set Spec2ImplPortList { 
	AB { ap_memory {  { AB_address0 mem_address 1 2 }  { AB_ce0 mem_ce 1 1 }  { AB_q0 mem_dout 0 128 } } }
