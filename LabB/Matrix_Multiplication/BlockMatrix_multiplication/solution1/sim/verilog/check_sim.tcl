...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.blockmatmul.autotvin_Arows_V_a_0.dat"
         "c.blockmatmul.autotvin_Arows_V_a_1.dat"
         "c.blockmatmul.autotvin_Arows_V_a_2.dat"
         "c.blockmatmul.autotvin_Arows_V_a_3.dat"
         "c.blockmatmul.autotvin_Bcols_V_a_0.dat"
         "c.blockmatmul.autotvin_Bcols_V_a_1.dat"
         "c.blockmatmul.autotvin_Bcols_V_a_2.dat"
         "c.blockmatmul.autotvin_Bcols_V_a_3.dat"
         "c.blockmatmul.autotvin_ABpartial_out.dat"
         "c.blockmatmul.autotvin_it.dat"
         "c.blockmatmul.autotvout_ABpartial_out.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.blockmatmul.autotvout_ABpartial_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
