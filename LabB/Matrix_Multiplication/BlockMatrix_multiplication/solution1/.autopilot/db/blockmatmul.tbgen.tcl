...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "5"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "190", "EstimateLatencyMax" : "207",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "1",
		...
		"InputProcess" : [
			{"ID" : "2", "Name" : "Loop_memset_AB_proc8_U0"}],
		"OutputProcess" : [
			{"ID" : "5", "Name" : "Loop_writeoutput_pro_U0"}],
		"Port" : [
			{"Name" : "Arows_V_a_0", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "Loop_memset_AB_proc8_U0", "Port" : "Arows_V_a_0"}]},
			{"Name" : "Arows_V_a_1", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "Loop_memset_AB_proc8_U0", "Port" : "Arows_V_a_1"}]},
			{"Name" : "Arows_V_a_2", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "Loop_memset_AB_proc8_U0", "Port" : "Arows_V_a_2"}]},
			{"Name" : "Arows_V_a_3", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "Loop_memset_AB_proc8_U0", "Port" : "Arows_V_a_3"}]},
			{"Name" : "Bcols_V_a_0", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "Loop_memset_AB_proc8_U0", "Port" : "Bcols_V_a_0"}]},
			{"Name" : "Bcols_V_a_1", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "Loop_memset_AB_proc8_U0", "Port" : "Bcols_V_a_1"}]},
			{"Name" : "Bcols_V_a_2", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "Loop_memset_AB_proc8_U0", "Port" : "Bcols_V_a_2"}]},
			{"Name" : "Bcols_V_a_3", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "Loop_memset_AB_proc8_U0", "Port" : "Bcols_V_a_3"}]},
			...
			{"Name" : "A", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "Loop_memset_AB_proc8_U0", "Port" : "A"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.AB_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Loop_memset_AB_proc8_U0", "Parent" : "0", "Child" : ["3", "4"],
		...
		"HasNonBlockingOperation" : "0",
		"Port" : [
			{"Name" : "AB", "Type" : "Memory", "Direction" : "IO", "DependentProc" : "5", "DependentChan" : "1"},
			{"Name" : "it", "Type" : "None", "Direction" : "I"},
			{"Name" : "Arows_V_a_0", "Type" : "Fifo", "Direction" : "I",
				"BlockSignal" : [
			...
			{"Name" : "A", "Type" : "Memory", "Direction" : "IO"}]},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Loop_memset_AB_proc8_U0.A_U", "Parent" : "2"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Loop_memset_AB_proc8_U0.blockmatmul_mux_4cud_U1", "Parent" : "2"},
...
set ArgLastReadFirstWriteLatency {
	...
	Loop_memset_AB_proc8 {
		AB {Type IO LastRead 8 FirstWrite 2}
		it {Type I LastRead 0 FirstWrite -1}
		Arows_V_a_0 {Type I LastRead 4 FirstWrite -1}
		Arows_V_a_1 {Type I LastRead 4 FirstWrite -1}
		Arows_V_a_2 {Type I LastRead 4 FirstWrite -1}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "190", "Max" : "207"}
	, {"Name" : "Interval", "Min" : "191", "Max" : "208"}
]}
