...
`define AUTOTB_TVIN_Arows_V_a_0  "./c.blockmatmul.autotvin_Arows_V_a_0.dat"
`define AUTOTB_TVIN_Arows_V_a_1  "./c.blockmatmul.autotvin_Arows_V_a_1.dat"
`define AUTOTB_TVIN_Arows_V_a_2  "./c.blockmatmul.autotvin_Arows_V_a_2.dat"
`define AUTOTB_TVIN_Arows_V_a_3  "./c.blockmatmul.autotvin_Arows_V_a_3.dat"
`define AUTOTB_TVIN_Bcols_V_a_0  "./c.blockmatmul.autotvin_Bcols_V_a_0.dat"
`define AUTOTB_TVIN_Bcols_V_a_1  "./c.blockmatmul.autotvin_Bcols_V_a_1.dat"
`define AUTOTB_TVIN_Bcols_V_a_2  "./c.blockmatmul.autotvin_Bcols_V_a_2.dat"
`define AUTOTB_TVIN_Bcols_V_a_3  "./c.blockmatmul.autotvin_Bcols_V_a_3.dat"
`define AUTOTB_TVIN_ABpartial_out  "./c.blockmatmul.autotvin_ABpartial_out.dat"
`define AUTOTB_TVIN_it  "./c.blockmatmul.autotvin_it.dat"
`define AUTOTB_TVIN_Arows_V_a_0_out_wrapc  "./rtl.blockmatmul.autotvin_Arows_V_a_0.dat"
`define AUTOTB_TVIN_Arows_V_a_1_out_wrapc  "./rtl.blockmatmul.autotvin_Arows_V_a_1.dat"
`define AUTOTB_TVIN_Arows_V_a_2_out_wrapc  "./rtl.blockmatmul.autotvin_Arows_V_a_2.dat"
`define AUTOTB_TVIN_Arows_V_a_3_out_wrapc  "./rtl.blockmatmul.autotvin_Arows_V_a_3.dat"
`define AUTOTB_TVIN_Bcols_V_a_0_out_wrapc  "./rtl.blockmatmul.autotvin_Bcols_V_a_0.dat"
`define AUTOTB_TVIN_Bcols_V_a_1_out_wrapc  "./rtl.blockmatmul.autotvin_Bcols_V_a_1.dat"
`define AUTOTB_TVIN_Bcols_V_a_2_out_wrapc  "./rtl.blockmatmul.autotvin_Bcols_V_a_2.dat"
`define AUTOTB_TVIN_Bcols_V_a_3_out_wrapc  "./rtl.blockmatmul.autotvin_Bcols_V_a_3.dat"
`define AUTOTB_TVIN_ABpartial_out_out_wrapc  "./rtl.blockmatmul.autotvin_ABpartial_out.dat"
`define AUTOTB_TVIN_it_out_wrapc  "./rtl.blockmatmul.autotvin_it.dat"
`define AUTOTB_TVOUT_ABpartial_out  "./c.blockmatmul.autotvout_ABpartial_out.dat"
`define AUTOTB_TVOUT_ABpartial_out_out_wrapc  "./impl_rtl.blockmatmul.autotvout_ABpartial_out.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.blockmatmul.autotvout_ABpartial_out.dat", "r");
    fp2 = $fopen("./impl_rtl.blockmatmul.autotvout_ABpartial_out.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.blockmatmul.autotvout_ABpartial_out.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.blockmatmul.autotvout_ABpartial_out.dat\"!");
    else begin
        $display("Comparing rtl.blockmatmul.autotvout_ABpartial_out.dat with impl_rtl.blockmatmul.autotvout_ABpartial_out.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
initial begin : proc_gen_Bcols_V_a_3_internal_ready
    ...
    `define STREAM_SIZE_IN_Arows_V_a_0 "./stream_size_in_Arows_V_a_0.dat"
    ...
    `define STREAM_SIZE_IN_Arows_V_a_1 "./stream_size_in_Arows_V_a_1.dat"
    ...
    `define STREAM_SIZE_IN_Arows_V_a_2 "./stream_size_in_Arows_V_a_2.dat"
    ...
    `define STREAM_SIZE_IN_Arows_V_a_3 "./stream_size_in_Arows_V_a_3.dat"
    ...
    `define STREAM_SIZE_IN_Bcols_V_a_0 "./stream_size_in_Bcols_V_a_0.dat"
    ...
    `define STREAM_SIZE_IN_Bcols_V_a_1 "./stream_size_in_Bcols_V_a_1.dat"
    ...
    `define STREAM_SIZE_IN_Bcols_V_a_2 "./stream_size_in_Bcols_V_a_2.dat"
    ...
    `define STREAM_SIZE_IN_Bcols_V_a_3 "./stream_size_in_Bcols_V_a_3.dat"
