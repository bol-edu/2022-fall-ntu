...
#pragma HLS ARRAY_RESHAPE variable=&AB complete dim=1
# 7 "BlockMatrix_design.cpp"

#pragma HLS ARRAY_RESHAPE variable=&AB complete dim=2
# 7 "BlockMatrix_design.cpp"
