# also change connectivity into 

# [connectivity]
# sp=runOnfpga_1.input_words:HBM[0:14] 
# sp=runOnfpga_1.output_flags:HBM[15:29] 
# sp=runOnfpga_1.bloom_filter:HBM[30]
...
./$(BUILDDIR)/runOnfpga_$(TARGET).xclbin: ./$(BUILDDIR)/runOnfpga_$(TARGET).xo
	v++ -l -g -t $(TARGET) -R 1 \
		...
		--report_dir ./$(BUILDDIR)/report_dir \
		--log_dir ./$(BUILDDIR)/log_dir \
		--config $(CURRENT_DIR)/connectivity_U50.cfg \
		-I$(SRCDIR) \
